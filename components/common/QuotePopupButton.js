...
/**
 * Button that opens the site-wide GetQuotePopup (via the shared custom event).
 * Reusable on any page — pass the label as children.
 */
export default function QuotePopupButton({ children = "Get a Quote", className = "btn btn-primary", arrow = true }) {
  return (
    <button
      type="button"
