...
// Mirrors the first (AI Services) tab's markup so the tab-switch script
    ...
    <section className="home-services full-section xl:pt-28 xl:pb-36">
      <div className="container">
        ...
        <TabContent
          id="tab1"
          active
          description="We deliver AI solutions that help businesses automate processes, improve customer experiences, and make smarter decisions. From AI software and agent development to AI SEO, consulting, and integrations, we build practical solutions designed to drive efficiency, growth, and measurable results."
          links={[
