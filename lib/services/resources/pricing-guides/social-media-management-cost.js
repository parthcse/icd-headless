...
const HowMuchDoesSocialMediaManagementCost = {
	...
	pageTitle: "How Much Does Social Media Management Cost in {{year}}?",
	metaDescription: "Get insights into {{year}} social media management pricing. Find out what you'll pay, what services are included, and how to choose the best option for your brand.",

	banner: {
		heading: "How Much Does Social Media Management Cost in {{year}}?",
		paragraphs: [
	...
	cta: {
		text: "Want to know how much you should budget for Social Media Management in {{year}}?",
	...
	plainText: {
		...
		paragraphs: [
			...
			"Knowing your social media management charges in {{year}} can help you plan better and align your resources accordingly. As compared to freelancers and DIY options, going with a social media marketing agency is a suitable option for all types of businesses. With years of experience and catering to companies in different industries, they have a clear understanding of what will work best for your business.",
