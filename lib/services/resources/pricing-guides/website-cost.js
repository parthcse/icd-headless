...
const HowMuchDoesAWebsiteCost = {
	...
	pageTitle: "How Much Does a Website Cost in {{year}}?",
	metaDescription: "How Much Does a Website Cost in {{year}}? Learn about website pricing, from DIY builders to professional development. Compare costs & find the best option for your budget.",

	banner: {
		heading: "How Much Does a Website Cost in {{year}}?",
		paragraphs: [
