		...
		items: [
			{
				...
				bodyAfter: "Suitable for: Businesses with a fixed project scope and clear requirements. Approximate Cost: $5,000 – $150,000",
			},
			{
				...
				bodyAfter: "Suitable for: Businesses with long-term requirements but no well-defined scope. Approximate Cost: $25 to $80 per hour",
			},
			{
				...
				bodyAfter: "Suitable for: Businesses requiring an expert to expand their in-house team. Approximate Cost: Vary as per skill required and project needs",
			},
		],
	},
