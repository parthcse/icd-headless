		...
		steps: [
			{
				...
				bodyList: [
					"Top of the funnel (Awareness): Work on educational content like blogs, videos, and guides to attract visitors.",
					"Middle of the funnel (Consideration): Create case studies, product comparisons, and testimonials to build trust.",
					"Bottom of the funnel (Decision): Optimize checkout pages, simplify the buying process, and use strong CTAs.",
				],
			},
			{
