	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "Yes. Webflow supports native integrations, API connections, and custom code embeds, letting you connect CRMs, marketing automation, payment gateways, analytics, booking tools, and more. Our developers can also build custom integrations tailored to your specific workflow so your site works seamlessly with the tools you rely on.",
			},
			{
				question: "How much does it cost to build a website with Webflow?",
				answer: "Cost depends on the scope — a simple marketing site is far less than a complex, CMS-driven or eCommerce build with custom integrations and animations. We offer flexible, transparent pricing with no hidden fees. Share your requirements and we'll provide a custom quote that fits your budget.",
			},
			{
				question: "How long does it take to develop a website using Webflow?",
				answer: "A straightforward Webflow site can be ready in 2–4 weeks, while larger projects with custom design, CMS, and integrations typically take 6–10 weeks or more. Webflow's visual tools speed up the process, and after reviewing your requirements we provide a clear, milestone-based timeline.",
			},
			{
				question: "Do I need coding skills to manage a Webflow website?",
				answer: "No. Webflow's visual editor and CMS let you update content, images, and pages without any coding. We hand over a well-structured site and can provide training or documentation so your team can confidently manage day-to-day updates on their own.",
			},
			{
				question: "Is Webflow SEO-friendly?",
				answer: "Yes. Webflow generates clean, semantic code and gives you full control over meta tags, alt text, headings, URLs, and automatic sitemaps. Combined with fast hosting and responsive design, it provides a strong SEO foundation — and we further optimize each site for speed, structure, and search visibility.",
			},
			{
				question: "Can Webflow support eCommerce websites?",
				answer: "Yes. Webflow includes eCommerce capabilities for product catalogs, carts, and secure checkout, with flexible design control over every part of the shopping experience. For more advanced needs, we can integrate third-party commerce tools and payment gateways to fit your business.",
			},
			{
				question: "Will my Webflow site be mobile-friendly?",
				answer: "Absolutely. Every Webflow site we build is fully responsive by default, adapting smoothly to desktop, tablet, and mobile screens. We follow a mobile-first approach and test across devices to ensure a consistent, fast, and user-friendly experience everywhere.",
			},
			{
				question: "What happens if I need support after my website is live?",
				answer: "We offer ongoing post-launch support and maintenance, including updates, new features, performance and security checks, and troubleshooting. With flexible support plans and a dedicated point of contact, our team stays available to keep your Webflow site running smoothly as your business grows.",
			},
		],
	},
