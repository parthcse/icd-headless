...
const PpcPackages = {
  slug: "ppc-packages",
  pageTitle: "PPC Packages | Affordable Google Ads Management Plans | Icecube Digital",
  metaDescription:
    "Explore Icecube Digital's affordable, tailor-made PPC packages for small, medium and large enterprises. Transparent Google Ads management pricing built to drive traffic and conversions.",
      ...
      [
        {
          name: "Basic",
          amount: "$0 – $400",
          meta: ["$399 Initial Campaign Setup Fees", "1 Account Handling", "$299 Monthly Maintenance Fees"],
          includePla: false,
        },
        {
          name: "Advanced",
          amount: "$4K – $7K",
          featured: true,
          meta: ["$399 Initial Campaign Setup Fees", "5–10 Account Handling", "20% Monthly Maintenance Fees"],
          includePla: true,
        },
        {
          name: "Enterprise",
          amount: "$7K & Above",
          meta: ["$399 Initial Campaign Setup Fees", "11–15 Account Handling", "18% Monthly Maintenance Fees"],
          includePla: true,
        },
      ],
