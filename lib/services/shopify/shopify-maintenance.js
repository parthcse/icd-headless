	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "Simply put, it’s a list of components in your Shopify store that need to be continuously monitored and optimized, along with a schedule for who should perform maintenance and when. However, if you don’t have the time or skills to handle the maintenance yourself, you can sign up for an ongoing support plan offered by Shopify maintenance service providers like IceCube Digital.",
			},
			{
				question: "How much is the cost of Shopify's maintenance and support?",
				answer: "The cost of a maintenance plan depends on the size of your site, what you want to do as part of its maintenance, and how often the maintenance is done.",
			},
			{
				question: "What types of site changes can I request?",
				answer: "You can request almost any type of change to your website. Shopify maintenance services include changes to the site’s theme, functionality, web design, layout, content, images, functionality, and more. Please discuss your custom requirements if you want any other changes not listed here. We are happy to help you.",
			},
			{
				question: "What about updates to the Shopify app and features?",
				answer: "Don’t worry about app and feature updates as we take care of all the necessary updates based on your requirements. Whether it’s a custom plugin integration or an existing feature that needs updating, we’ve got you covered.",
			},
			{
				question: "How do Shopify maintenance services help in improving store speed and performance?",
				answer: "Shopify maintenance services include regularly checking your eCommerce website’s speed, optimizing the images, eliminating or refining the scripts, and even updating the app. All these refinements not only improve fast loading times but also help boost customer satisfaction and SEO rankings. An optimized website is what Google and everyone else love.",
			},
			{
				question: "What are the factors that affect the Shopify site’s performance?",
				answer: "There are three main factors that affect the Shopify site’s performance:",
				answerList: [
					"Online store theme",
					"Installed apps",
					"Additional third-party codes or API integrations",
				],
			},
			{
				question: "What are the updates that happen during Shopify maintenance?",
				answer: "Your eCommerce store needs to be updated frequently because no one likes an outdated store. Regular updates are necessary to keep your store aligned with customers’ evolving needs and popular trends to keep pace with the industry. Here are some of the updates that are a part of the Shopify maintenance service:",
				answerList: [
					"Theme update",
					"Plugin update",
					"Shopify store app update",
					"Content update",
					"Security update",
				],
			},
			{
				...
				answer: "To protect your website from cyber-attacks and security breaches, here’s what our team does:",
				answerList: [
					"Update the SSL certificates to ensure end-to-end encrypted data transfer.",
					"Set up firewalls to block unauthorized access.",
					"Perform regular malware scans to detect and remove malicious software.",
					"Conduct monthly website and security audits to identify and fix vulnerabilities.",
				],
			},
			{
				question: "How responsive is your customer support team?",
				answer: "At Icecube Digital, we provide end-to-end customer support services after deploying your store. While we support maintenance services and work in the backend continuously to monitor and improve your store’s performance, issues can arise. Our responsive customer support teams are available 24/7 to help you resolve your issues. You can contact them through any communication channel, like phone call, text, or email, and our knowledgeable team will troubleshoot the technical issues at the earliest",
			},
		],
	},
