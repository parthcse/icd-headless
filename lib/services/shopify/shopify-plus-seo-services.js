...
const ShopifyPlusSeoServices = {
	...
	caseStudy: {
		...
		title: "How We Help Shopify Plus Brands Scale",
		subtitle: [
	...
	plainTextSecondary: {
		eyebrow: "Fuel Your SEO Strategy With Shopify Plus",
		title: "SEO Experts",
		contentAlign: "center",
		blocks: [
			{
				type: "p",
				text: "95% of Shopify stores fail to survive in their initial days, as they fail to attract and retain customers. While Shopify Plus is a step up from standard Shopify plans with advanced features like customizable checkouts, automation, and API integrations, it has limitations in search marketing. If search engines are your primary traffic source, you need technical SEO enhancements, schema implementation, and on-page optimization to gain more visibility and drive qualified leads.",
			},
			{
				type: "p",
				text: "Whether your store is new or established, Icecube Digital is here to achieve eCommerce success. Our data-driven SEO strategies, including site audits, structured data, and keyword mapping, can position your store at the top of search results. We adopt a holistic approach with technical optimization, authoritative backlinks, and content enhancements to drive visibility, ensure seamless UX, and deliver measurable results.",
			},
			{
				type: "p",
				text: "Our Shopify Plus SEO services have helped countless businesses fine-tune their site architecture, improve indexing, and maximize organic traffic. We’d love to do the same for you!",
			},
		],
	},
	...
	tableSeoPlans: {
		...
		planLabel: "CUSTOM SHOPIFY PLUS SEO PLANS",
		price: "599",
		period: "Monthly",
