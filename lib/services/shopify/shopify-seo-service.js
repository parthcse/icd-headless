...
const ShopifySeoService = {
	...
	banner: {
		heading: "Result-Driven Shopify SEO Services",
		paragraphs: [
			"Want to boost organic traffic to your Shopify website? Do you want to double the sales of your e-commerce business? Icecube Digital is a team of Shopify SEO specialists with adequate experience and expertise in delivering a range of Shopify SEO services for your versatile e-commerce store. Just share your requirements with us TODAY!",
		],
	...
	infoBox: {
		...
		items: [
			...
			{
				title: "We're transitioning to Shopify and need thorough SEO support. Can you assist us?",
			...
			{
				title: "As a Fortune 500 Company, we're looking for a Shopify SEO Agency that can handle everything from shopify maintenance to SEO",
				body: [
	...
	leftIconBox: {
		...
		items: [
			...
			},
			{
				...
				body: [
					"Generate distinct webpages for each niche sub-category derived from the overarching categories. This level of organization facilitates clients' ability to locate precisely what they require. Here, a ",
					{ bold: "Shopify e-commerce SEO expert's" },
			...
			},
			{
				...
				body: [
					"Canonicalization and canonical elements should be utilized to prevent SEO-harming penalties for duplicate content. ",
					{ bold: "Hire Shopify SEO experts" },
					" who can quickly implement these correctly.",
				],
			},
			{
	...
	tableSeoPlans: {
		...
		planLabel: "CUSTOM SHOPIFY SEO PLANS",
		price: "599",
		period: "Monthly",
	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "On-site SEO focuses on optimizing the website itself. It includes elements such as the website’s content, meta tags, structure, HTML code, images, videos, etc. While off-site SEO focuses on improving the website’s visibility and credibility through external factors. This includes link building, social media optimization, and other activities that aim to increase the visibility and authority of a website. Both are important for a successful overall SEO strategy, and they complement each other to help a website rank higher on search engines.",
			},
			{
				question: "How much does Shopify SEO service cost?",
				answer: "The cost of Shopify SEO services depends on various factors, including the size and complexity of the website, the services included in the package, the location and experience of the service provider, and the duration of the contract. On average, a basic Shopify SEO package can cost anywhere from $500 to $5,000 per month based on the project scope. It’s very important to consider the experience, track record, and reputation of the provider, as well as the services included in the package and the results that you can expect to see from the shopify search engine optimization efforts.",
			},
			{
				question: "Can you guarantee rankings for my Shopify project?",
				answer: "Most ethical Shopify SEO companies do not provide any kind of guarantee as they can’t really control the outcome. A reputable SEO agency can help improve your website’s visibility and ranking on search engine results pages (SERPs) through best practices such as keyword research, on-page optimization, link building, and content creation. These efforts can increase your website’s relevance and authority in the eyes of search engines, which can lead to higher rankings and more organic traffic.",
			},
			{
				question: "What are Shopify local rankings or local SEO?",
				answer: "Shopify local rankings, or local SEO, refers to the optimization of a Shopify website for local search results. Local SEO is a specialized form of SEO that focuses on optimizing a website to appear in local search results when people search for products or services in a specific geographic location. Local SEO can be particularly important for businesses that operate in a specific geographic location, such as brick-and-mortar stores, local service providers, and online businesses that serve customers in a specific area. The local SEO activities include Google Business listing optimization, ensuring website includes consistent local business information such as NAP (Name, Address, Phone number), Building high-quality local citations, optimizing website landing pages for different locations, etc.",
			},
			{
				question: "Why is it important to hire Shopify SEO consultants for my website?",
				answer: "There are several reasons to hire shopify SEO consultant for your website such as.: Expertise: Shopify SEO consultants have the expertise and experience needed to effectively optimize your website for search engines. They have a deep understanding of search engine algorithms and ranking factors, and can help identify and address any technical or content-related issues that may be impacting your website’s performance. Time-saving: Optimizing a website on a daily basis can be a daunting and time-consuming process. By hiring a Shopify expert or SEO expert, you can save time and focus on running your business, while the consultant handles the optimization efforts. Cost-effective: Hiring a Shopify SEO consultant can be more cost-effective than hiring a full-time in-house team, especially for small to medium-sized businesses. With hire a shopify seo consultant, you only pay for the services you need and can avoid the cost and overhead of a full-time employee. Results-driven: Shopify SEO consultants specialize in delivering tangible, measurable results for their clients. By working with a consultant, you can get regular reports and updates on your website’s performance and track the progress of your optimization efforts. Continuous optimization: Search engine algorithms and ranking factors are constantly changing and evolving, so it’s important to have a team that stays up-to-date with the latest best practices and trends. Shopify SEO consultants can provide continuous optimization efforts to help keep your website ranking well in search results.",
			},
			{
				question: "How do you do SEO on Shopify websites?",
				answer: "We Follow the below steps to optimize the Shopify website for SEO. Choose a Good URL Structure: We make sure that URLs are short, descriptive, and include relevant keywords. Optimize your page titles and meta descriptions: We ensure that they are unique, include relevant keywords, and accurately describe the content of your pages. Use Heading tags: Properly using heading tags (H1, H2, H3, etc.) can help search engines understand the structure and hierarchy of your content. Add Alt Text to Images: Our SEO experts add descriptive alt text to website images to help them rank better in image search results. Use Product Descriptions: We make sure that product descriptions are unique, well-written, and include relevant keywords. Utilize Shopify’s Built-In Blogging Platform: Blogging is a great way to build a following, increase your website’s traffic, and improve your SEO. We use Shopify’s built-in blogging platform to publish regular content and link to website products. Install an SEO App: Shopify has many apps available that can help you with website SEO. Some popular options include the SEO Manager and the SEO Doctor apps. Promote your site on Social Media: Social media can drive more traffic to your site and help you build your brand. Our SEO experts share top selling products and blog posts on social media profiles, and encourage followers to share content as well.",
			},
			{
				question: "What are the challenges with SEO on a Shopify website?",
				answer: "Since Shopify is a hosted platform, you don’t have full control over its SEO. Here are some issues that you face with Shopify SEO. Duplicate Content: Shopify generates duplicate content for products, collections, and pages, which can negatively impact your website’s search engine ranking. Though, Shopify allows for fixes, it needs help from web developer to modify the code in the backend of the theme. URL Structure: Shopify’s default URL structure may not be optimized for search engines, and it can be difficult to change without the use of third-party apps or custom development. Limited Customization: Shopify’s themes and templates offer limited customization options, which can make it difficult to make the necessary on-page optimizations for search engines. No control over robots.txt: Shopify’s platform doesn’t allow website owners to make manual edits to their website’s robots.txt file. Which can make it difficult to exclude products that go out of stock. Load Time: Shopify stores can become slow due to the high number of plugins, themes, and app integrations. A slow website can negatively impact your search engine ranking and user experience. Overall, Shopify is a great platform for e-commerce business owners, but it requires careful attention to detail and a proactive approach to SEO in order to achieve the best results in search engines.",
			},
			{
				question: "How do I know if SEO is working for our business?",
				answer: "You can take a look at following aspects to confirm that SEO is working for your business: Increased Organic Traffic: You can monitor the organic traffic through Google Analytics and search console tools. If our SEO efforts are working, you should see a steady increase in organic traffic over time. Improved Keyword Rankings: Monitor your website’s search engine rankings for target keywords. If your rankings are improving, it is a sign that your SEO efforts are working. Increased Conversion Rates: Increased traffic is great, but it’s even better if that traffic is converting into leads or sales. You can track conversion rates through Google Analytics or by using conversion tracking tool. Increased Branded Search Volume: Track the volume of searches for your brand name. If your brand is becoming more recognizable and people are searching for your brand name more frequently, it’s a good sign that your SEO efforts are working. Increased Backlinks: Track the number of backlinks pointing to your website. Backlinks are a crucial factor in determining your website’s search engine ranking, and an increase in backlinks is a good sign to ensure that SEO efforts are working.",
			},
		],
	},
