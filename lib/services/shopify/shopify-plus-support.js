	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "We suggest continuous assistance where you have weekly or monthly checks, according to the complexity and the store traffic.",
			},
			{
				question: "Will you streamline my Shopify Plus store?",
				answer: "Yes, we check load times, image optimization, code streamlining, and best practices to increase site performance and speed.",
			},
			{
				question: "Are you able to maintain the updates of apps and plugins?",
				answer: "Yes, we maintain all apps, plugins, and integrations to make sure that they are compatible with Shopify Plus without conflict.",
			},
			{
				question: "Do you provide security monitoring of Shopify Plus stores?",
				answer: "Yes, we monitor vulnerabilities, implement security patches, and make sure that your store follows the security standards of Shopify.",
			},
			{
				question: "Can you assist with Shopify Plus theme customizations?",
				answer: "Yes, we also update the theme, make it custom-designed, and add features to enhance the UX and make it fit the branding.",
			},
			{
				question: "Do you provide maintenance including SEO and analytics?",
				answer: "Yes, we do track the performance of websites and recommendations on how to improve the performance of the website in terms of SEO, conversion rate, and user experience.",
			},
			{
				question: "What is the difference between the agency support and Shopify Plus support?",
				answer: "Shopify Plus does not do custom development or theme development, app conflicts, CRO optimization, or performance optimization, even though they offer platform-level support. We as an agency handle the real-world development, customizations, bug resolution, and constant optimization so that you can have resolutions and business-oriented solutions quicker.",
			},
			{
				question: "Can your Shopify Plus support service scale with the expansion of our business?",
				answer: "Yes, we have support plans that will be scaled with your business. Whether you are introducing new functionality, you need high-traffic campaigns, expanding into a new country, or integrating third-party systems, we scale up and down our support and development according to your growth requirements.",
			},
		],
	},
