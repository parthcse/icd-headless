...
const JewelryWebsiteDesignDevelopment = {
	...
	plainText: {
		eyebrow: "Partner With The Best",
		title: "Jewelry Website Development Company",
		contentAlign: "center",
		paragraphs: [
			...
			"With years of experience and expertise in jewelry website design, jewelry ecommerce store development and internet marketing (SEO) for jewelry store across geographical locations, we specialize in custom jewelry website design.",
	...
	topIconBoxQuinary: {
		eyebrow: "Your Vision, Our Solutions For",
		title: "Ultimate Growth",
		columns: 4,
		items: [
			{
				icon: "/assets/icons/code-monitor.svg",
				title: "Modern Tech",
				body: "300+ projects. Clear vision."
			},
			{
				icon: "/assets/icons/result.svg",
				title: "Proven Results",
				body: "Tech that wins. Lasting impact."
			},
			{
				icon: "/assets/icons/www.svg",
				title: "Global Reach",
				body: "Innovating in 10+ countries."
			},
			{
				icon: "/assets/icons/award-badge.svg",
				title: "Certified Excellence",
				body: "Recognized for proven innovation."
			},
		],
	},
	...
	// common section: components/home/GetQuoteSection.js — second "Get a Free Quote" before Countries We Serve.
