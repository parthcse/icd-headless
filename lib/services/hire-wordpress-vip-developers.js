...
const HireWordPressVipDevelopers = {
	...
	iconCards: {
		...
		items: [
			{
				icon: "/images/website-cms.svg",
				name: "Custom WordPress VIP Website Development",
			...
			{
				icon: "/images/theme-monitor.svg",
				name: "Custom WordPress VIP Theme Development",
			...
			},
			{
				...
				name: "WooCommerce VIP Solutions",
	...
	iconCardsSecondary: {
		...
		items: [
			{
				name: "Media & Publishing Companies",
		...
		items: [
			{
				...
				name: "Certified & Experienced WordPress VIP Experts",
			...
			{
				icon: "/images/thumbs-up.svg",
				name: "Proven Success with Enterprise Clients",
			...
			},
			{
				...
				name: "Custom Solutions for Business Growth",
			...
			{
				icon: "/images/flexible-pricing.svg",
				name: "Transparent Pricing & Flexible Hiring",
			...
			{
				icon: "/images/enterprise-security.svg",
				name: "Advanced Security & Performance Optimization",
