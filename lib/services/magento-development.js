...
const MagentoDevelopment = {
  ...
  topIconBoxSecondary: {
    ...
    items: [
      ...
      { icon: "/assets/icons/smart.svg", title: "Multiple Shipping Methods", body: "Magento supports various shipping methods, allowing customers to choose their preferred shipping option. From standard shipping to express delivery and click-and-collect, Magento provides a seamless shipping experience." },
