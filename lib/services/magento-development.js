...
const MagentoDevelopment = {
  ...
  iconCardsSecondary: {
    ...
    items: [
      ...
      { icon: "/assets/icons/minicsrt.svg", name: "Offline Service", body: "Magento offers offline service capabilities, allowing you to serve customers even when they are not connected to the internet. Whether offline browsing or order placement, Magento ensures a seamless shopping experience regardless of internet availability." },
