...
const MagentoDevelopment = {
  ...
  clientSuccess: {
    ...
    // TODO: replace with the real WordPress `portfolio` post IDs for these case studies (Baby Kingdom, Vuba Supplies, Visor)
    postIds: [71, 65, 73],
  ...
  clientRetention: {
    ...
    title: "Generative AI",
    image: "/images/majento-development.png",
    imageAlt: "",
    paragraphs: [
  ...
  clientTrust: {
    ...
    items: [
      { icon: "/images/services-offers-2.svg", name: "Magento Website Development & Design", body: "We design a state-of-the-art Magento eCommerce website with exquisite features and functionality for your business. After carefully listening to your requirements, our web developers and designers employ their skills to render every possible service, from front-end coding to plugin interaction." },
      { icon: "/images/div-close.svg", name: "Custom Module Development", body: "We bring your visionary concepts to life with our custom Magento development services with tailored functionalities and meet your business requirements. Our designers will create a distinctive e-commerce experience to deliver a seamless experience for web and mobile users." },
      { icon: "/images/grid.svg", name: "Magento Theme Development", body: "Our brilliant squad of designers creates responsive and visually appealing themes for your Magento store. We help you stand out from the crowd with our excellence in Magento theme development by working closely with you, enhancing the user experience and strengthening your brand presence." },
      { icon: "/images/services-offers-1.svg", name: "Magento Maintenance and Support", body: ["We make sure to continue the robust relationship with our customers even after the launch of their Magento store. Our ", { text: "hired Magento developers", href: "#" }, " will provide ongoing support and maintenance to keep your website safe, up-to-date, and seamlessly operating with devoted developers by your side."] },
      { icon: "/images/Processing.svg", name: "Magento Migration Services", body: "We help you avoid the hassles in migrating your website to Magento through our comprehensive Magento web development services. We help you move the website to the latest and chosen Magento platform while ensuring the safety and integrity of your data and the website's better performance and experience." },
      { icon: "/images/mobile.svg", name: "Headless PWA for Magento 2", body: "Hire our Magento developers to develop PWA with headless architecture, which ensures that every user can access your store on any tablet or smartphone while enjoying a seamless purchasing experience. The robust PWA will supercharge your eCommerce business, saving you time and money in the long run." },
      { icon: "/images/setting.svg", name: "Magento 2 API Intigration", body: "Connect your Magento store with any third-party tool, app, or service using our tailor-made Magento web development services and enhance your customer experience. Using the integration service, you can carry out different tasks via a single dashboard and generate a smooth and effortless transition." },
      { icon: "/images/services-offers-4.svg", name: "FrontEnd Development Service", body: "We augment your store in Magento by implementing the interactive front-end development service, creating stunning and pixel-perfect web and mobile applications. We are equipped with cutting-edge responsiveness to deliver a responsive and intuitive visual experience for your business." },
      { icon: "/images/Inventory.svg", name: "Multilingual Store Development", body: "A multilingual store development allows multiple global vendors to sell their products in a single ecosystem without language barriers. Our developers will develop an online marketplace website by harnessing the potential of our individualized Magento development services to deliver the best shopping experience." },
      { icon: "/images/services-offers-7.svg", name: "Payment, Shipping, and Gateway Integration", body: "Our Magento web development services include payment, shipping, and gateway integration, enabling you to streamline purchasing processes. Our professional developers integrate popular getaways, ensuring security and customer confidence while synchronizing your data, enhancing workflows, gaining efficiency, and saving money." },
      { icon: "/images/half-circle.svg", name: "Performance Optimization", body: "With our inclusive Magento development services and optimization strategies, we optimize the performance and effectiveness of your online store. Our optimization services include quick page loads, opalized codes, top-notch user experiences, and more." },
      { icon: "/images/cloud.svg", name: "Commerce Cloud Service", body: "Fuel your e-commerce experience across every challenge by bringing digital commerce, point-of-sale, store operations, order management, and predictive intelligence into shared commerce experience through our Magento development services." },
    ],
  },
  ...
  clientTrustSecondary: {
    ...
    subtitle: "Leveraging Magento's powerful features will enhance your site performance, optimize the loading speed, and ensure smooth navigation. At Icecube Digital, our Magento development services will empower you to deliver an exceptional digital experience that sets you apart in the competitive landscape and indulges your customer at every touchpoint.",
    items: [
      { icon: "/images/services-offers-2.svg", name: "Build Scalable Store", body: "Magento development services have emerged as a preferable choice for small and large organizations to build scalable stores that can handle large amounts of traffic and expand their online presence." },
      { icon: "/images/grid.svg", name: "Create Robust architecture", body: "More technology is included in the Magento development services to increase website optimization and customization. The latest architecture of Magento serves as a powerhouse of speed and performance for your business to stay ahead of its competitors." },
      { icon: "/images/div-close.svg", name: "Access Flexible APIs", body: "Magento provides a better e-commerce experience and is a demanding solution due to its features and functionality. It is accessible to flexible APIs, including simple management, server customization, and product bundling." },
      { icon: "/images/services-offers-4.svg", name: "Leverage ready-to-use extensions", body: "With Magento, you can also access additional extensions to optimize your website for a better experience and user experience." },
      { icon: "/images/services-offers-7.svg", name: "Multiple Payment Methods", body: "When you have Magento development services for your eCommerce stores, you can stay carefree as you will have access to multiple, secured payment methods. It allows on-site payments by enabling integration to various gateways." },
      { icon: "/images/services-offers-1.svg", name: "Utility Tool", body: "Magento offers a wide array of utility tools to smoothen the operation process of an eCommerce store right from the beginning to the end." },
      { icon: "/images/half-circle.svg", name: "Fast Rendering", body: "With its optimised codebase and caching mechanisms, Magento ensures fast rendering and quick loading times for your website. This enhances user experience and reduces bounce rates, leading to higher conversion rates and customer satisfaction." },
      { icon: "/images/Smart.svg", name: "Multiple Shipping Methods", body: "Magento supports various shipping methods, allowing customers to choose their preferred shipping option. From standard shipping to express delivery and click-and-collect, Magento provides a seamless shipping experience." },
      { icon: "/images/Valuet.svg", name: "Inventory Control", body: "Effectively manage your inventory with Magento's robust inventory management features. Track stock levels set up notifications for low stock, and streamline your supply chain processes for efficient inventory control." },
      { icon: "/images/minicsrt.svg", name: "Offline Service", body: "Magento offers offline service capabilities, allowing you to serve customers even when they are not connected to the internet. Whether offline browsing or order placement, Magento ensures a seamless shopping experience regardless of internet availability." },
      { icon: "/images/Smart-Search.svg", name: "Powerful Search", body: "Magento's advanced functionality allows customers to find products quickly and easily. With features like faceted search, auto-suggestions, and filtering options, Magento provides a powerful search experience that improves customer satisfaction and conversion rates." },
      { icon: "/images/services-offers-6.svg", name: "Real-Time Security", body: "Magento is a highly secured platform to operate e-commerce stores. The built-in security features will reduce the risk of cyber-attacks and remove the data vulnerability to advance the security of your business." },
      { icon: "/images/result.svg", name: "Boost Website Performance", body: "When it comes to website performance, Magento development services will enable you to build fast-loading pages." },
    ],
  },
  ...
  qualityWebsites: {
    ...
    items: [
      { icon: "/images/user-round.svg", name: "Exceptional Expertise", body: "By harnessing the latest advancements and innovations in technology, Icecube Digital will be your supportive development company, ensuring to provide solutions with cutting-edge industry standards. With our profound expertise in tailoring Magento and experience in developing advanced applications, we ensure to carve solutions that meet your exact requirements in every aspect." },
      { icon: "/images/comment.svg", name: "Absolute Transparency", body: "From the beginning, we aspire to establish transparency and open lines of communication in our Magento development services, actively listening to your challenges and goals. With our deeper understanding of the platform and its abilities, we offer end-to-end solutions encompassing everything from design and development to integration and support, ensuring you get the best possible results with absolute transparency." },
      { icon: "/images/Valuet.svg", name: "Customer-Centric Approach", body: "Icecube Digital has always excelled in the industry as the finest Magento eCommerce development company. Our customized solutions will consistently lead your business to profound heights in the client's market. It will also help you meet the growing demands of your business and provide a superior online shopping experience to your customers, creating a unique brand identity and boosting your bottom line." },
      { icon: "/images/services-offers-5.svg", name: "On-Time and In-Budget Delivery", body: "Experience intelligent solutions with on-time and affordable delivery with the greatest Magento website Design/Development company in the USA. Whether it's project progress or timelines, we will update you on the project status at all times so that you can feel valued by our services. Our experienced and dedicated Magento developers work round the clock to ensure every client's project is completed before the pre-defined schedule." },
    ],
  },
