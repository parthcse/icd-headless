...
const MagentoDevelopment = {
  ...
  clientTrustSecondary: {
    ...
    items: [
      ...
      { icon: "/images/Value.svg", name: "Inventory Control", body: "Effectively manage your inventory with Magento's robust inventory management features. Track stock levels set up notifications for low stock, and streamline your supply chain processes for efficient inventory control." },
  ...
  qualityWebsites: {
    ...
    items: [
      ...
      { icon: "/images/Value.svg", name: "Customer-Centric Approach", body: "Icecube Digital has always excelled in the industry as the finest Magento eCommerce development company. Our customized solutions will consistently lead your business to profound heights in the client's market. It will also help you meet the growing demands of your business and provide a superior online shopping experience to your customers, creating a unique brand identity and boosting your bottom line." },
