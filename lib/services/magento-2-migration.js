...
const HireMagento2Migration = {
  ...
  clientRetention: {
    ...
    image: "/images/majento-2migration.png",
    imageAlt: "",
    blocks: [
  ...
  clientRetentionSecondary: {
    ...
    image: "/images/majento-2migration-1.png",
    imageAlt: "",
    imagePosition: "right",
    blocks: [
    ...
    items: [
      {
        ...
        name: "Magento 2 Upgrade (Version Updates)",
        bodyList: [
      ...
      },
      {
        ...
        name: "Magento Migration (Magento 1 / Other Platforms)",
        bodyList: [
      ...
      },
      {
        ...
        name: "Custom Development & Optimization",
        bodyList: [
      ...
      {
        icon: "/images/seo.svg",
        name: "SEO Protection During Migration",
        bodyList: [
  ...
  clientTrust: {
    ...
    items: [
      ...
      {
        icon: "/images/services-offers-6.svg",
      ...
      },
      {
        ...
        name: "Future-Ready Architecture",
  ...
  qualityWebsitesSecondary: {
    ...
    items: [
      {
        icon: "/images/count-1.svg",
        name: "Store Audit & Planning",
      ...
      {
        icon: "/images/count-3.svg",
        name: "Upgrade / Migration Execution",
  ...
  clientTrustSecondary: {
    ...
    items: [
      {
        name: "Proven Magento Experience",
      ...
      {
        name: "Zero-Risk Migration Approach",
