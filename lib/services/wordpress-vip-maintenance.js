...
const WordPressVipMaintenance = {
	...
	featureCardsSecondary: {
		...
		items: [
			{
				icon: "/assets/icons/count-1.svg",
				name: "Initial Assessment & Onboarding",
			...
			{
				icon: "/assets/icons/count-2.svg",
				name: "Proactive Monitoring & Issue Detection",
