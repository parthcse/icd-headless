...
const WordPressVipMaintenance = {
	...
	portfolio: {
		eyebrow: "Our",
		title: "Portfolio",
		subtitle: "Imagine having an enterprise WordPress Website that works with 99.9% uptime, enterprise-grade security, and easily handles the high-traffic load. That's what our WordPress VIP website maintenance agency does for you. We stand up to our promises, and our portfolio section is the proof. Discover our diverse portfolio to explore how we brought the optimum solution that scales our clients' businesses. Each story is a milestone in our journey that stands as a testament to the meeting of expectations and satisfaction of our valued partners and customers.",
		postIds: [71, 65, 73],
	...
	iconCards: {
		eyebrow: "Our WordPress VIP Enterprise",
		...
		items: [
			{
				icon: "/images/enterprise-security.svg",
				name: "DDOS Threat Analysis & Mitigation",
			...
			},
			{
				...
				name: "Advanced Debugging & Issue Resolution",
			...
			},
			{
				...
				name: "Seamless WordPress Upgrades",
			...
			{
				icon: "/images/eye.svg",
				name: "Real-Time Downtime Monitoring",
			...
			},
			{
				...
				name: "Comprehensive Security Audits",
			...
			},
			{
				...
				name: "Theme & Plugin Support & Maintenance",
			...
			{
				icon: "/images/performance-gauge.svg",
			...
			{
				icon: "/images/Detection.svg",
				name: "Malware Scan/Removal",
				body: "Running your website smoothly and without any glitches is the most important thing in your business. To make this possible, our WordPress developers scan malware and identify breaches to prevent imminent attacks. In fact, our team keeps scanning your site for any malware to clean and remove it in just a minute.",
			},
		],
	},
	...
	iconCardsSecondary: {
		...
		items: [
			...
			{
				icon: "/images/multisite.svg",
				name: "Multisite & Domain Management",
			...
			},
			{
				icon: "/images/web.svg",
				name: "Managed CDN",
				body: "WordPress VIP leverages a global CDN (Content Delivery Network) to distribute the website's content across strategically located servers worldwide. It ensures lightning-fast load times for all users across borders, contributing to a globally optimized user experience and improved engagement.",
			},
			{
				icon: "/images/chart-growth.svg",
				name: "Effortless Scaling",
				body: "WordPress VIP helps your organization's website to scale effortlessly. It handles sudden surges in traffic without downtime and provides advanced content management tools to optimize your digital marketing or eCommerce strategies. The platform is designed for updates by an expert WordPress development agency, making it a convenient choice for scaling and future-proofing your digital presence.",
			},
			{
				icon: "/images/shield-check.svg",
				name: "Automatic Updates & Security Patches",
				body: "Security is a top priority for WordPress VIP. It proactively monitors and protects the website from malware and vulnerabilities. Additionally, traffic is encrypted end-to-end, providing businesses peace of mind while handling sensitive data. The platform also prioritizes automated updates and accessibility, ensuring the website adheres to industry-specific compliance requirements.",
			},
			{
				icon: "/images/time.svg",
				name: "99.95% Uptime Guarantee",
	...
	iconCardsTertiary: {
		...
		subtitles: [
			"Since its inception, WordPress VIP has grown to cater to the demands of both small and large businesses alike. It is now the most popular CMS, used by 24.8% of businesses. WordPress VIP can improve your security and scale the business growth. Let's take a closer look at how it achieves the goal:",
		],
		items: [
			{
				icon: "/images/trusted.svg",
				name: "Enterprise-Level Compliance & Certifications",
			...
			{
				icon: "/images/shield-check.svg",
				name: "Robust Network & Data Security",
			...
			},
			{
				...
				name: "Comprehensive Physical Security",
			...
			{
				icon: "/images/database-backup.svg",
				name: "Reliable Data Backup & Disaster Recovery",
			...
			{
				icon: "/images/setting.svg",
				name: "Automated & Manual Code Security Audits",
	...
	featureCards: {
		...
		items: [
			...
			{
				icon: "/images/multisite.svg",
				name: "eCommerce & Multisite Support",
			...
			{
				icon: "/images/admin-control.svg",
				name: "User Role & Access Management",
			...
			{
				icon: "/images/affordable.svg",
				name: "Cost-Effective & Reliable Service",
		...
		items: [
			{
				...
				answer: "WordPress VIP is a premium managed WordPress hosting platform designed for enterprise-level websites that demand the highest standards of performance, security, and reliability. Unlike standard WordPress hosting, WordPress VIP provides a fully managed infrastructure with enterprise-grade CDN, 24/7 expert support, SOC 2-compliant security, automatic scaling, and strict code quality standards — making it the platform of choice for major publishers, enterprises, and high-traffic websites worldwide.",
			},
			{
				question: "What is the difference between WordPress VIP and Traditional WordPress?",
				answer: "Traditional WordPress is a self-managed platform where you handle hosting, updates, security, and performance yourself or through a third-party host. WordPress VIP, by contrast, is a fully managed enterprise platform that provides dedicated infrastructure, global CDN, automatic scaling, continuous security monitoring, and a team of WordPress experts ensuring your site operates at peak performance at all times. WordPress VIP also enforces strict code quality standards and offers guaranteed uptime SLAs that standard WordPress cannot match.",
			},
			{
				question: "How much does WordPress VIP cost?",
				answer: "WordPress VIP pricing varies based on the scale of your enterprise, traffic levels, and the specific services required. The platform itself is an enterprise investment, and our maintenance packages are tailored to complement it. Contact our team for a custom quote — we'll assess your current WordPress VIP setup, identify your support requirements, and recommend the most cost-effective maintenance plan to keep your site running flawlessly.",
			},
			{
				question: "What does WordPress VIP not include?",
				answer: "WordPress VIP provides the managed infrastructure and platform, but it does not include custom theme or plugin development, content creation, marketing services, or ongoing design work by default. It also does not cover day-to-day content updates, custom feature development, or third-party integrations out of the box. This is where our WordPress VIP maintenance and support services come in — filling the gaps and handling all the ongoing technical and operational needs your team requires.",
			},
			{
				question: "Why does my WordPress VIP business need a WordPress maintenance agency?",
				answer: "Even with WordPress VIP's enterprise infrastructure, your website still needs expert hands-on maintenance to stay optimized, secure, and aligned with your business goals. A dedicated WordPress maintenance agency like Icecube Digital provides proactive monitoring, regular performance audits, theme and plugin management, security hardening, custom feature support, and strategic guidance — ensuring your VIP investment delivers maximum ROI and your site remains competitive in an ever-evolving digital landscape.",
			},
		],
	},
