...
import whiteLabelWordpress from "./white-label-wordpress";
...
const MAP = {
  "white-label-wordpress": whiteLabelWordpress,
  // "woocommerce-development": woocommerceDevelopment,
  // "shopify-development": shopifyDevelopment,
  // Add new entries here ↑ (slug must match the file's slug field)
};
