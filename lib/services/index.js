...
import { resolveYearTokens } from "../current-year";
...
import HowMuchDoesEcommerceSeoCost from "./resources/pricing-guides/ecommerce-seo-cost";
import HowMuchDoesMagentoSeoCost from "./resources/pricing-guides/magento-seo-cost";
...
import ElectricianWebDesign from "./industry/industry-electrician-web-design";
import RealEstateWebDesign from "./industry/industry-real-estate-web-design";
import SportsWebDesign from "./industry/industry-sports-web-design";
import RoofingSeo from "./industry/industry-roofing-seo";
import RestaurantWebDesign from "./industry/industry-restaurant-web-design";
import SchoolWebDesign from "./industry/industry-school-web-design";
import TravelWebDesign from "./industry/industry-travel-web-design";
import CleaningWebDesign from "./industry/industry-cleaning-web-design";
import PlumberWebDesign from "./industry/industry-plumber-web-design";
import LawFirmWebDesign from "./industry/industry-law-firm-web-design";
import MedicalHealthcareWebDesign from "./industry/industry-medical-healthcare-web-design";
import FitnessSeo from "./industry/industry-fitness-seo";
import FoodBeverageWebDesign from "./industry/industry-food-beverage-web-design";
import NycSeoCompany from "./location/location-nyc-seo";
import DallasSeoConsultant from "./location/location-dallas-seo";
import ChicagoSeoCompany from "./location/location-chicago-seo";
import PittsburghSeoCompany from "./location/location-pittsburgh-seo";
import DenverSeoAgency from "./location/location-denver-seo";
import SeattleSeoCompany from "./location/location-seattle-seo";
import BostonSeoServices from "./location/location-boston-seo";
import MiamiSeo from "./location/location-miami-seo";
import PerthSeo from "./location/location-perth-seo";
import LasVegasSeo from "./location/location-las-vegas-seo";
import AustinSeo from "./location/location-austin-seo";
import TheWoodlandsSeo from "./location/location-the-woodlands-seo";
import HoustonSeo from "./location/location-houston-seo";
import SanFranciscoSeo from "./location/location-san-francisco-seo";
import PhiladelphiaSeo from "./location/location-philadelphia-seo";
import SanDiegoSeo from "./location/location-san-diego-seo";
import SydneySeo from "./location/location-sydney-seo";
import MelbourneSeo from "./location/location-melbourne-seo";
import BrisbaneSeo from "./location/location-brisbane-seo";
import LosAngelesSeo from "./location/location-los-angeles-seo";
import AtlantaSeo from "./location/location-atlanta-seo";
import MobileApplication from "../company/mobile-application";
import DevelopmentPartnership from "../company/development-partnership";
import WhyWorkWithUs from "../company/why-work-with-us";
import AmazonSeoServices from "./digital-marketing/amazon-seo";
import DigitalMarketingAnalyticsReportingServices from "./digital-marketing/marketing-analytics-reporting";
import AmazonPpcManagementServices from "./digital-marketing/amazon-ppc";
import SocialMediaMarketingManagement from "./digital-marketing/social-media-marketing";
import SaasDigitalMarketingAgency from "./digital-marketing/saas-marketing";
import SocialMediaAdvertisingServices from "./digital-marketing/social-media-advertising";
import InternationalSeoServices from "./digital-marketing/international-seo";
import AiDigitalMarketingServices from "./ai/ai-digital-marketing";
import LaravelDevelopmentCompanyUk from "./wordpress/laravel-development-uk";
import WordPressDevelopmentCompanyUk from "./wordpress/wordpress-development-uk";
import WebsiteMaintenanceService from "./wordpress/website-maintenance";
import BigcommerceToShopifyMigrationServices from "./shopify/bigcommerce-to-shopify-migration";
import WoocommerceToShopifyMigrationServices from "./shopify/woocommerce-to-shopify-migration";
import TechnicalSeoServices from "./digital-marketing/technical-seo";
import OnPageSeoServices from "./digital-marketing/on-page-seo";
import PerformanceMarketingServices from "./digital-marketing/performance-marketing";
import HireNextJsDevelopers from "./development/hire-nextjs";
import HireNodeJsDevelopers from "./development/hire-nodejs";
import HireReactJsDevelopers from "./development/hire-reactjs";
import NodeJsDevelopmentServices from "./development/nodejs-development";
import ReactJsDevelopmentServices from "./development/reactjs-development";
import AngularJsDevelopment from "./development/angular-development";
import CodeigniterDevelopmentServices from "./development/codeigniter-development";
import CustomPhpDevelopmentServices from "./development/php-development";
import MovingCompanyWebsiteDesignServices from "./industry/industry-moving-company-web-design";
import SeoCompanyAhmedabad from "./special/seo-company-ahmedabad";
import SeoCompanyGujarat from "./special/seo-company-gujarat";
import DigitalMarketingAgencyAhmedabad from "./special/digital-marketing-agency-ahmedabad";
import AiConsulting from "./ai/ai-consulting";
import AiIntegration from "./ai/ai-integration";
import AiAgentDevelopment from "./ai/ai-agent-development";
import AiSoftwareDevelopment from "./ai/ai-software-development";
import ChatgptAdvertising from "./ai/chatgpt-advertising";
import AiSeo from "./ai/ai-seo-services";
import ShopifyDevelopmentUk from "./shopify/shopify-development-company-uk";
import PhotographyWebDesign from "./industry/industry-photography-web-design";
import JewelryWebPortal from "./industry/industry-jewelry-web-portal";
import WordPressMalwareRemoval from "./wordpress/wordpress-malware-removal";
import OffPageSeo from "./digital-marketing/off-page-seo-services";
import KlaviyoEmailMarketing from "./digital-marketing/klaviyo-email-marketing-agency";
import MagentoToShopifyMigration from "./shopify/magento-to-shopify-migration";
import LocalSeo from "./digital-marketing/local-seo-services";
...
const MAP = {
  ...
  "how-much-does-ecommerce-seo-cost": HowMuchDoesEcommerceSeoCost,
  "how-much-does-magento-seo-cost": HowMuchDoesMagentoSeoCost,
  ...
  "electrician-web-design-services": ElectricianWebDesign,
  "real-estate-website-design-development": RealEstateWebDesign,
  "sports-website-design": SportsWebDesign,
  "roofing-seo-company": RoofingSeo,
  "restaurant-website-design-development": RestaurantWebDesign,
  "school-website-design": SchoolWebDesign,
  "travel-website-design-development": TravelWebDesign,
  "cleaning-company-web-design-company": CleaningWebDesign,
  "plumbers-web-design-services": PlumberWebDesign,
  "law-firm-website-design-development": LawFirmWebDesign,
  "medical-healthcare-website-design-development": MedicalHealthcareWebDesign,
  "fitness-seo-and-digital-marketing": FitnessSeo,
  "food-beverage-website-design": FoodBeverageWebDesign,
  "nyc-seo-company": NycSeoCompany,
  "dallas-seo-consultant": DallasSeoConsultant,
  "chicago-seo-company": ChicagoSeoCompany,
  "pittsburgh-seo-company": PittsburghSeoCompany,
  "denver-seo-agency": DenverSeoAgency,
  "seattle-seo-company": SeattleSeoCompany,
  "boston-seo-services": BostonSeoServices,
  "miami-seo-company": MiamiSeo,
  "seo-services-perth": PerthSeo,
  "las-vegas-seo-company": LasVegasSeo,
  "austin-seo-company": AustinSeo,
  "the-woodlands-seo-company": TheWoodlandsSeo,
  "houston-seo-company": HoustonSeo,
  "san-francisco-seo-company": SanFranciscoSeo,
  "philadelphia-seo-company": PhiladelphiaSeo,
  "san-diego-seo-company": SanDiegoSeo,
  "seo-services-sydney": SydneySeo,
  "seo-services-melbourne": MelbourneSeo,
  "seo-services-brisbane": BrisbaneSeo,
  "los-angeles-seo-company": LosAngelesSeo,
  "atlanta-seo-services-company": AtlantaSeo,
  "mobile-application": MobileApplication,
  "development-partnership": DevelopmentPartnership,
  "why-work-with-us": WhyWorkWithUs,
  "amazon-seo-services": AmazonSeoServices,
  "digital-marketing-analytics-reporting-services": DigitalMarketingAnalyticsReportingServices,
  "amazon-ppc-management-services": AmazonPpcManagementServices,
  "social-media-marketing-management": SocialMediaMarketingManagement,
  "saas-digital-marketing-agency": SaasDigitalMarketingAgency,
  "social-media-advertising-services": SocialMediaAdvertisingServices,
  "international-seo-services": InternationalSeoServices,
  "ai-digital-marketing-services": AiDigitalMarketingServices,
  "laravel-development-company-uk": LaravelDevelopmentCompanyUk,
  "wordpress-development-company-uk": WordPressDevelopmentCompanyUk,
  "website-maintenance-service": WebsiteMaintenanceService,
  "bigcommerce-to-shopify-migration-services": BigcommerceToShopifyMigrationServices,
  "woocommerce-to-shopify-migration-services": WoocommerceToShopifyMigrationServices,
  "technical-seo-services": TechnicalSeoServices,
  "on-page-seo-services": OnPageSeoServices,
  "performance-marketing-services": PerformanceMarketingServices,
  "hire-next-js-developers": HireNextJsDevelopers,
  "hire-nodejs-developers": HireNodeJsDevelopers,
  "hire-reactjs-developers": HireReactJsDevelopers,
  "nodejs-development-services": NodeJsDevelopmentServices,
  "reactjs-development-services": ReactJsDevelopmentServices,
  "angular-js-development": AngularJsDevelopment,
  "codeigniter-development-services": CodeigniterDevelopmentServices,
  "custom-php-development-services": CustomPhpDevelopmentServices,
  "moving-company-website-design-services": MovingCompanyWebsiteDesignServices,
  "seo-company-ahmedabad": SeoCompanyAhmedabad,
  "seo-company-gujarat": SeoCompanyGujarat,
  "digital-marketing-agency-ahmedabad": DigitalMarketingAgencyAhmedabad,
  "ai-consulting-services": AiConsulting,
  "ai-integration-services": AiIntegration,
  "ai-agent-development-services": AiAgentDevelopment,
  "ai-software-development-services": AiSoftwareDevelopment,
  "chatgpt-advertising-services": ChatgptAdvertising,
  "ai-seo-services": AiSeo,
  "shopify-development-company-uk": ShopifyDevelopmentUk,
  "photography-website-design-services": PhotographyWebDesign,
  "custom-jewelry-web-portal-development": JewelryWebPortal,
  "wordpress-malware-removal-service": WordPressMalwareRemoval,
  "off-page-seo-services": OffPageSeo,
  "klaviyo-email-marketing-agency": KlaviyoEmailMarketing,
  "magento-to-shopify-migration-services": MagentoToShopifyMigration,
  "local-seo-services": LocalSeo,
 ...
 * resolveYearTokens replaces any `{{year}}` in the page's data with the current
 * year — so you can write "How Much Does SEO Cost in {{year}}?" in the data file
 * and it stays current automatically. No-op for pages that don't use the token.
 */
export function getServiceData(slug) {
  const data = MAP[slug];
  return data ? resolveYearTokens(data) : null;
}
