...
const HireNextJsDevelopers = {
	...
	checkList: {
		...
		benefitsLeft: [
			"Step 1 - Share your requirements by connecting with our team.",
			"Step 2 - We will shortlist a few candidates from our pool of Next.js developers based on different filters.",
			"Step 3 - Conduct an interview and technical assessment of the shortlisted candidates to find your perfect match.",
			"Step 4 - Discuss the engagement models and begin the project work as soon as possible.",
		],
	},
