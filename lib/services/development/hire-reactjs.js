...
const HireReactJsDevelopers = {
	...
	processSteps: {
		...
		steps: [
			{
				title: "Step 1",
				body: "Share your project requirements with our team."
			},
			{
				title: "Step 2",
				body: "Our team shortlists the expert developer’s profile, which aligns perfectly with your business demands."
			},
			{
				title: "Step 3",
				body: "Choose a developer or a team of ReactJS developers from the shortlisted ones."
			},
			{
				title: "Step 4",
				body: "The chosen developers will be onboarded to your team and start working on the project."
			},
		],
	},
