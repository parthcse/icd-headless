...
const JewelryWebPortal = {
	...
	infoBox: {
		eyebrow: "Types of Web Portals We",
		title: "Develop for Your Business",
	...
	leftIconBoxSecondary: {
		eyebrow: "Why Choose Icecube Digital for Your",
		title: "Jewelry Web Portal?",
		items: [
			{
