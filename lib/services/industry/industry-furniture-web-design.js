...
const FurnitureWebsiteDesignDevelopment = {
	...
	imageTextBlocks: [
		{
			eyebrow: "Design Meets Digital Scale —",
			title: "Furniture Done Smarter",
			subtitles: [
				...
				[{ bold: "Built for the Modern Furniture Business" }],
				"Our furniture eCommerce solutions blend design, performance, and marketing. They integrate configuration, pricing intelligence, AR visualization, multi-channel fulfillment, and automated marketing to build a connected and profitable digital ecosystem.",
			],
	...
	topIconBox: {
		...
		subtitles: [
			[
				"With the digital world's expansion, ample e-commerce platforms provide undefined facilities and features to facilitate ",
				{ bold: "furniture store website design" },
				" and establishment. Out of all the available options, how do you recognize which is best suited for your business? Let's compare all the available options in the market.",
			],
		],
		items: [
			{
