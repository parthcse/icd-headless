...
const AutomotiveWebsiteDesign = {
	...
	leftIconBox: {
		...
		subtitle: [
			[
				"Icecube Digital specializes in assisting auto-related businesses and dealerships with their online success through the provision of premium ",
				{ bold: "automotive web design services." },
				" Owing to performance optimization and website migration, we have more than a decade of experience developing high-converting digital solutions for the automotive industry.",
			],
		],
		items: [
			{
			...
			},
			{
				...
				body: [
					"Continuous maintenance and support are provided to guarantee optimal functionality and availability of your website at all times. Our ",
					{ bold: "automotive website developers" },
					" proactively monitor sites, give updates, deploy security patches, repair bugs, and prevent problems before they impact your company.",
				]
			},
			{
	...
	leftIconBoxSecondary: {
		...
		items: [
			...
			},
			{
				...
				body: [
					"End-to-end eCommerce solutions provide substantial advantages for the consumer experience. Increasing customer contentment by permitting them to manage initial research, pricing, financing, and new/used vehicle configuration details at their convenience. Our ",
					{ bold: "automotive ecommerce website" },
					" solutions centralize previously disjointed processes onto a single platform, giving customers more control over buying and servicing journeys.",
				]
			},
			{
