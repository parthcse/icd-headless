		...
		items: [
			{
				...
				body: [
					"The design and navigation are responsible for the online purchasing experience. Being a leading ",
					{ bold: "WooCommerce development agency" },
					", we ensure the component is done well with our WooCommerce website development services.",
				],
			},
			{
			...
			},
			{
				title: "SEO Friendly",
				body: [
					"SEO is something to consider while building a website. Therefore, we can deliver ",
					{ bold: "WooCommerce development services" },
					" that perform better and generate higher ROIs.",
				],
			},
			{
	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "We take data privacy very seriously. Before you disclose the specifics of the WooCommerce project with us, we would be pleased to sign an NDA and confidentiality agreement.",
			},
			{
				question: "How Much Time Does It Take To Build A Woocommerce Website?",
				answer: "Since every project is different, the time required for development depends on the project’s size, complexity, and scope.",
			},
			{
				question: "How Do I Track The Woocommerce Development Progress Of The Project?",
				answer: "The project manager assigned to your project will keep you updated on all progress, and we maintain complete transparency with our clients. Also, you can always contact us by phone, email, instant messaging, or other means.",
			},
			{
				question: "Do You Provide Post-Completion Support For The Woocommerce Projects After The Project Delivery?",
				answer: "Every project that Icecube Digital delivers includes a support period. Any sudden issues on your website throughout the support time will be free of charge and evaluated by our seasoned experts.",
			},
			{
				question: "Do You Optimize The Websites For SEO?",
				answer: "Everything in a fully-fledged WooCommerce project is SEO optimized to bring you the best results and draw traffic from the target market, including your content and meta tags.",
			},
			{
				question: "Is Woocommerce Suitable For A Large Store?",
				answer: "Our talented website designers and professional digital marketing specialists create dynamic business websites using cutting-edge technologies and tried-and-true techniques for Small and large organizations.",
			},
			{
				question: "How To Boost Conversions For My Woocommerce Site?",
				answer: "Making your website’s navigation quick and simple will increase the conversion rate of your WooCommerce business. Additionally, you can utilize more sophisticated techniques like content marketing, running campaigns, and more.",
			},
			{
				question: "Is It Possible To Sell Subscription-Based Products Or Services With Woocommerce?",
				answer: "WooCommerce makes it simple to sell goods and services using subscription models. There are other plugins, though, one of which is WooCommerce Subscriptions.",
			},
			{
				question: "How Can I Integrate New Features Into The Woocommerce Website?",
				answer: "You have a wide range of alternatives, and many of the plugins are free or have freemium versions, so you can use most of the fundamental functionality without spending more money.",
			},
			{
				question: "What Payment Types Do You Accept?",
				answer: "We accept payment via PayPal, bank transfer, and all major credit cards.",
			},
			{
				question: "Do You Offer A Payment Schedule?",
				answer: "Yes, we divide the payment according to the size and type of the project.",
			},
		],
	},
