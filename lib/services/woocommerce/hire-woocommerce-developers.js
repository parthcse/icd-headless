	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "You will have full ownership of the website and the code that we build for you. On completion of the project, our WooCommerce development team hands over the complete source code and moves it to your hosting environment, so you retain full rights over your website and its code.",
			},
			{
