	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "The timeline depends on the scope of your project. A simple store with a pre-built theme can be ready in 2–4 weeks, while a fully custom store with bespoke design, custom features, and third-party integrations typically takes 6–12 weeks or more. After reviewing your requirements, we provide a clear, milestone-based timeline so you know exactly what to expect.",
			},
			{
				question: "How Does Your eCommerce Website Design Process Work?",
				answer: "Our process starts with understanding your business goals, brand, and target audience. From there we move through wireframing and UI/UX design, development and customization, content and app integration, thorough testing, and launch. We keep you involved with regular reviews at every stage, and provide ongoing support after go-live.",
			},
			{
				question: "Do you offer ongoing support and maintenance after development?",
				answer: "Yes. We provide ongoing support and maintenance including bug fixes, performance optimization, security updates, theme and app updates, and feature enhancements. You can choose a maintenance plan that fits your needs to keep your Shopify store fast, secure, and up to date.",
			},
			{
				question: "How Do We Communicate Throughout the Project?",
				answer: "You'll have direct, regular communication with your developer or team through your preferred channels — email, Slack, Skype, video calls, or project management tools like Jira and Trello. We follow agile practices with frequent updates and reviews so you always know the status of your project.",
			},
			{
				question: "Why Should I Hire Shopify Experts from IceCube Digital?",
				answer: "With over a decade of experience and 100+ successful Shopify projects, our certified developers bring deep platform expertise, proven results, and a customer-first approach. We deliver tailored, scalable, and conversion-focused stores, offer flexible engagement models, and provide reliable ongoing support — making us a trusted long-term partner for your eCommerce growth.",
			},
			{
				question: "Did you sign an NDA? If so, what is the procedure?",
				answer: "Yes. We're happy to sign a Non-Disclosure Agreement before discussing your project in detail. You can share your own NDA or use ours; once it's reviewed and signed by both parties, we proceed with onboarding while keeping all your business information and data strictly confidential.",
			},
			{
				question: "What is the cost of hiring a Shopify developer?",
				answer: "The cost depends on the engagement model (dedicated, hourly, or project-based), the complexity and scope of your project, required integrations, and the developer's experience level. We offer flexible, transparent pricing tailored to your needs — contact us for a custom quote based on your specific requirements.",
			},
			{
				question: "Can you migrate my existing store to Shopify without losing data?",
				answer: "Yes. We handle full migrations from platforms like Magento, WooCommerce, BigCommerce, and custom solutions, safely transferring your products, customers, orders, and SEO data with minimal downtime. We set up proper redirects and run thorough testing to ensure nothing is lost and your rankings are preserved.",
			},
			{
				question: "What experience do you have with Shopify custom development and third-party app integrations?",
				answer: "Our team has extensive experience with custom theme and app development using Liquid, the Storefront and Admin APIs, GraphQL, and Hydrogen for headless commerce. We've integrated CRMs, ERPs, payment gateways, marketing tools, and inventory systems, building tailored solutions that fit each client's unique workflow.",
			},
			{
				question: "Can you optimize my Shopify store for better speed and SEO?",
				answer: "Absolutely. We improve Core Web Vitals by optimizing images, code, apps, and theme structure, and we handle technical SEO, structured data, on-page optimization, and site architecture. Together these boost loading speed, search visibility, and conversions for your store.",
			},
			{
				question: "Will I have full ownership and control over my Shopify store after development?",
				answer: "Yes. You retain complete ownership and admin control of your Shopify store, themes, and content. On completion we hand over all access and credentials, and we can provide documentation or training so you can manage your store independently.",
			},
			{
				question: "What is your process for handling revisions or changes during the project?",
				answer: "Revisions are a normal part of our collaborative process. We gather your feedback at each milestone and incorporate changes within the agreed scope. For requests outside the original scope, we discuss the impact on timeline and cost transparently before proceeding, so there are no surprises.",
			},
			{
				question: "Do you provide training or documentation on managing my Shopify store after development?",
				answer: "Yes. We provide handover documentation and can arrange training sessions to walk you through managing products, orders, content, and any custom features we've built. Our goal is to make sure your team feels confident running the store day to day, with our support available whenever you need it.",
			},
		],
	},
