...
const WordPressWebsiteDesign = {
	...
	iconCards: {
		...
		subtitle:
			"Icecube Digital is a custom WordPress development company that does not rely on template solutions or shortcut strategies. Every project is designed with a goal that integrates your business goals, requirements, and a strategy to transform your website into an actual growth asset. We offer WordPress website development services that are unique to your business needs and are scalable for long-term growth.",
		items: [
			{
				icon: "/images/new-development.svg",
				name: "New WordPress Website Development",
				body: ["Our ", { text: "WordPress website design agency", href: "#" }, " is ready to incorporate your suggestions and create the smooth website you have always wanted. Our professionals will ensure that the website design is exactly what you want."],
			},
			{
				icon: "/images/redesign.svg",
				name: "WordPress Website Re-design",
			...
			{
				icon: "/images/custom-design.svg",
				name: "Custom WordPress Web Design",
			...
			},
			{
				...
				name: "WordPress Website Speed Optimization",
			...
			},
			{
				...
				name: "Multisite & Multilingual Development",
			...
			},
			{
				...
				name: "Accessibility & Data Privacy Essentials",
	...
	iconCardsSecondary: {
		...
		subtitle:
			"Icecube Digital is your one-stop solution for a user-friendly and visually appealing website design. Here are the reasons why collaborating with Icecube Digital for WordPress web design services can prove beneficial for you.",
		items: [
			{
				icon: "/images/website-analytics.svg",
				name: "Superior Website Analytics",
			...
			{
				icon: "/images/project-goals.svg",
				name: "Define The Project Goals Before Beginning",
			...
			{
				icon: "/images/seamless-delivery.svg",
				name: "Seamless WordPress Services Delivery",
			...
			},
			{
				...
				name: "Exceptional Support and Constant Communication",
			...
			},
			{
				...
				name: "Giving You Complete Control",
	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "While standard WordPress setups use themes and plugins that don't require coding, achieving a truly custom design involves HTML, CSS, PHP, and JavaScript. At Icecube Digital, our developers handle all the technical coding on your behalf, so you get a custom, high-performing website without needing any coding knowledge yourself.",
			},
			{
				question: "What is the cost of a WordPress website design?",
				answer: "The cost of a WordPress website design varies depending on the complexity of the design, number of pages, custom functionality, and integrations required. A basic WordPress website design can start from $1,000, while a fully custom design with advanced features can go upwards of $10,000. Contact us for a tailored quote based on your specific requirements.",
			},
			{
				question: "Does Icecube Digital offer WordPress website development services?",
				answer: "Yes, Icecube Digital offers comprehensive WordPress website development services alongside design. From custom theme development and plugin integration to headless WordPress architecture and WooCommerce setup, we handle the full development lifecycle to deliver a website that is both visually compelling and technically robust.",
			},
		],
	},
