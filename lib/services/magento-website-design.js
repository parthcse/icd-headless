...
const MagentoWebsiteDesign = {
  ...
  clientSuccess: {
    ...
    // TODO: replace with the real WordPress `portfolio` post IDs for these case studies (Baby Kingdom, Vuba Supplies, Show Your Spirit)
    postIds: [71, 65, 73],
  ...
  clientRetention: {
    ...
    image: "/images/majento-website-design.png",
    imageAlt: "",
    paragraphs: [
  ...
  clientTrust: {
    ...
    subtitle:
      "While Magento provides a solid foundation with a basic web design package and versatile templates, Icecube Digital takes it a step further. Our expertise lies in elevating your Magento site to high-end levels, especially focusing on creating a powerful and responsive design. From configuring products to optimizing search rankings, securing hosting, integrating apps, and designing your storefront, Icecube Digital ensures your Magento experience is exceptional.",
    subtitleSuffix: " Here are some reasons why Magento should be your go-to-platform for an eCommerce website.",
    items: [
      {
  ...
  clientTrustSecondary: {
    ...
    subtitle:
      "As a leading Magento web design agency, besides offering effective designs, we also provide effortless integration and a responsive design that adapts to diverse devices, ensuring a flawless user experience. Here are some reasons why you can trust Icecube Digital",
    items: [
      {
        icon: "/images/user-round.svg",
        name: "Expertise That Transcends",
      ...
      {
        icon: "/images/web.svg",
        name: "Tailored for Your Success",
      ...
      {
        icon: "/images/services-offers-1.svg",
  ...
  qualityWebsites: {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Brainstorm User Interface Design",
      ...
      },
      {
        ...
        body: [
          "We even offer ",
          { text: "Magento website development services", href: "#" },
    ...
    items: [
      {
        ...
        answer:
          "Our team's extensive knowledge and hands-on experience in professional Magento website design services, coupled with a commitment to tailored solutions, distinguish us. We prioritize understanding your unique business needs to deliver impactful and customized web designs that drive growth.",
      },
      {
        question: "Why choose an in-house team for Magento web design?",
        answer:
          "Unlike outsourcing, our in-house Magento website designers stay updated on the latest trends and best practices. This ensures optimal outcomes for your online store, driven by a dedicated team dedicated to excellence.",
      },
      {
        question: "How does Icecube Digital approach Magento eCommerce design differently?",
        answer:
          "Our approach is rooted in a deep understanding of the Magento platform, translating into bespoke solutions that go beyond aesthetics. We focus on creating designs that not only look impressive but also align strategically with your business goals.",
      },
      {
        question: "Can Icecube Digital cater to a global clientele with USA-based operations?",
        answer:
          "Absolutely! Icecube Digital is uniquely positioned to serve Magento eCommerce design needs globally.",
      },
      {
        question: "Are long-term contracts mandatory for Icecube Digital's Magento design services?",
        answer:
          "No, they're not. At Icecube Digital, we offer top-tier Magento eCommerce design services without the constraints of long-term contracts. We believe in flexibility, allowing you the freedom to work with us until you achieve your desired results for your online store.",
      },
    ],
  },
