...
const WordPressVipServices = {
	...
	topIconBoxSecondary: {
		...
		subtitles: [
			[
				"Your business website is the powerhouse of your brand's existence. Standard WordPress can be a limiting aspect of high traffic in your business. This is exactly where we as a WordPress VIP partner come in. Here is a list of services we offer as a ",
				{ text: "WordPress Development Company", href: "/wordpress-development-services/" },
				":",
			],
		],
		items: [
	...
	topIconBox: {
		...
		footerNote: [
			"These are some of the aspects that make WordPress VIP a compelling choice for brands that aspire to grow big. If you still have any doubts you can consider reaching out to us or ",
			{ text: "hiring WordPress developers", href: "/hire-wordpress-developers-designers/" },
			".",
		],
	},
		...
		items: [
			{
				...
				answerList: [
					[{ bold: "Small and simple website:" }, " We will be handling the transition manually. During the migration, we would be ensuring all the functionality and content is transferred without any fail."],
					[{ bold: "Large website:" }, " For this the manual process might lead us to miss out on content during the transfer. We would prefer to use the WordPress VIP Command Line Interface (CLI) tool for accurate transition."],
				],
			},
			{
				...
				answerList: [
					[{ bold: "Scalability:" }, " As your business grows and attracts more visitors, WordPress VIP ensures the website is ready to take the load. With an increase in traffic, your business will not be compromising with speed and stability."],
					[{ bold: "Wide range of security:" }, " There are inbuilt features like DDoS protection and regular vulnerability checks, which ensure the website is secure from any kind of cyber attacks on your valuable customer data."],
					[{ bold: "Seamless Integration:" }, " There are many e-commerce tools that you would like to integrate with your website once the business paces up. WordPress VIP will help you integrate essential e-commerce tools and payment gateways hassle-free."],
					[{ bold: "High performance:" }, " Websites with delayed loading time will lose many potential customers even after ranking high on the Search Engine. WordPress VIP makes sure your business doesn’t destabilize because of infrastructure failure. A smooth and quick shopping experience is what makes the consumer revisit."],
				],
			},
			{
			...
			},
			{
				...
				answerList: [
					[{ bold: "IP address:" }, " It is used for dummy user or bot detection. This tool is used to understand the geographical trends of the audience. Even though IP addresses alone are not considered personally identifiable information (PII) under most data privacy acts."],
					[{ bold: "User-agent:" }, " It can identify the type of browser and device used to access the website (e.g., mobile phone, desktop, Internet Explorer browser)."],
					[{ bold: "Anonymous identifier:" }, " This tracks the user behavior across engagement without revealing the person. Later on, this data can be very beneficial while making business decisions."],
					[{ bold: "Browsing history:" }, " As a business owner, you might be interested in knowing what the audience is looking for in the website. You can analyze how the users are navigating your website and what content resonates with them the most."],
				],
			},
			{
				...
				answerList: [
					[{ bold: "Version control:" }, " Code changes typically take place within a version control system like Github."],
					[{ bold: "Staging environment:" }, " It is very important before pushing the code into production we must test it through a staging environment. Codes are tested and refined in the staging environment that reflects your production website."],
					[{ bold: "Code review:" }, " Once testing is done, the code undergoes the process of review to ensure quality and alignment with best code practices."],
					[{ bold: "Deployment:" }, " Once the code approval phase is done, then the code is pushed to the production environment on the WordPress VIP infrastructure."],
				],
			},
		],
	},
