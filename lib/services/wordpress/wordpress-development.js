...
const WordPressDevelopment = {
	...
	banner: {
		...
		closingParagraph: "Turn your website into a powerful sales channel — schedule your free consultation today.",
	...
	infoBox: {
		...
		title: "Development Challenges We Solve",
		subtitle:
	...
	topIconBox: {
		...
		items: [
			...
			},
			{
				...
				body: "We help you design eCommerce website solutions that are optimized for end-to-end services, right from product management to checkout.",
			},
			{
			...
			},
			{
				...
				body: ["Continuous website maintenance is a part of our services. We take care of updates and offer performance monitoring and proactive ", { text: "WordPress maintenance services", href: "/wordpress-maintenance-service/" }, " so that your website remains reliable and secure."],
			},
			{
				icon: "/assets/icons/support-call.svg",
				title: "WordPress AI Integration Development",
				body: ["To enhance user experience, boost customer engagement and automation, we provide ", { text: "AI integration services", href: "/ai-integration-services/" }, " that can drive conversions."],
			},
		],
	},
	...
	infoBoxSecondary: {
		...
		subtitle:
			"When you choose WordPress development services USA businesses rely on for growth, your company gains measurable, long-term advantages. Partnering with us can help you in achieving enhanced web performance, increased revenue, and improved overall business results. By availing the custom WordPress development services of Icecube Digital, you gain:",
		gridClass: "sm:grid-cols-2 lg:grid-cols-3",
		items: [
			{
	...
	leftIconBox: {
		...
		items: [
			...
			},
			{
				...
				body: "Most of our clients continue working with us beyond the initial launch for maintenance and updates. We have 95% client retention rate, which reflects the trust which we have built with our customers by offering consistent deliveries.",
			},
		],
	},
	...
	tableBasic: {
		...
		subtitle:
			"Every project is a tailored investment based on your business goals, complexity, and growth requirements. Therefore, the WordPress development pricing also varies according to the feature needs, goals, complexities, and customizations. Our ultimate goal is to provide customized WordPress website services instead of one-size fits all price.",
	...
	checkList: {
		...
		benefitsLeft: [
			[{ bold: "CMS & Framework:" }, " WordPress Core, Headless WordPress"],
			[{ bold: "Performance & Security:" }, " Cloudflare, WP Rocket, Redis, Wordfence"],
			[{ bold: "AI & Automation:" }, " Intelligent chatbots, personalization engines, analytics & conversion optimization tools"],
		],
		benefitsRight: [
			[{ bold: "Page Builders & Editors:" }, " Elementor, Gutenberg, Advanced Custom Fields"],
			[{ bold: "eCommerce:" }, " WooCommerce, Stripe, PayPal integrations"],
		],
	},
	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "The cost of WordPress website development depends on your project scope, design complexity, and required features. A simple website costs less, while fully custom, scalable solutions require higher investment. Most businesses choose tailored WordPress development services for better long-term ROI.",
			},
			{
				question: "How long does a WordPress project take?",
				answer: "Most WordPress web development projects take 4–8 weeks, depending on complexity. Simple websites can be completed faster, while fully custom WordPress website development projects may take longer due to design, integrations, and testing requirements.",
			},
			{
				question: "What is the difference between WordPress.com and WordPress.org?",
				answer: "The key difference between the two versions is how your website is hosted. WordPress.com is a hosted platform where the website is managed for you. However, WordPress.org is a self-hosted platform, and it gives businesses complete control over design, functionality, and hosting.",
			},
			{
				question: "Can you migrate my existing site to WordPress?",
				answer: "Yes, we provide WordPress migration services to help you move from platforms like Shopify, Magento, or custom systems. Our process ensures your content, design, and SEO performance are preserved without disruptions.",
			},
			{
				question: "Do you offer WordPress maintenance after launch?",
				answer: "Yes, we offer ongoing WordPress maintenance services, including updates, security monitoring, performance optimization, and issue resolution to keep your website running smoothly after launch.",
			},
			{
				question: "What industries do you build WordPress sites for?",
				answer: "As an experienced Wordpress development company in the USA, we have been developing WordPress websites for over a decade for a range of industries, like furniture, fashion, eCommerce, automotive, jewellery, medical & health, education & training, travel & tourism, sports, HVAC & industrial, and even firearms.",
			},
			{
				question: "How does AI integrate into WordPress development?",
				answer: "AI enhances WordPress development by enabling smarter user experiences, personalized content, and automated interactions. It helps improve engagement, streamline workflows, and optimize conversion paths, making your website more effective in modern search and user environments.",
			},
			{
				question: "Do you offer custom WordPress development or use templates?",
				answer: "We specialize in custom WordPress development tailored to your business goals. While templates can be used for faster turnaround when needed, most projects are built with custom design and functionality to ensure better performance, scalability, and a unique brand experience.",
			},
			{
				question: "Will my WordPress website be fast and mobile-friendly?",
				answer: "Yes, every WordPress website we build is optimized for speed and fully responsive across all devices. We follow performance best practices, optimize Core Web Vitals, and ensure smooth user experience on mobile, tablet, and desktop for better engagement and conversions.",
			},
			{
				question: "What happens after my website goes live?",
				answer: "After launch, we provide ongoing WordPress maintenance, performance monitoring, and security updates to keep your website running smoothly. We also support future enhancements, feature updates, and optimization so your website continues to grow with your business.",
			},
		],
	},
