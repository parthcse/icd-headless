	...
	topIconBoxSecondary: {
		...
		items: [
			...
			},
			{
				...
				body: ["With hands-on experience in delivering a range of the best WordPress maintenance services, our team of ", { text: "WordPress developers", href: "/hire-wordpress-developers-designers/" }, " will take regular backups of your core files and database to avoid any hindrance. Regular backups of files and databases are important in any case; if there is any rollback, you get the latest version of your files and data."],
			},
			{
		...
		items: [
			{
				...
				answer: "WordPress maintenance is a set of steps that you need to undertake in order to keep your WordPress website optimized, and secure and run it like a well-oiled machine. We offer well-organized WordPress maintenance plans for small to large size of businesses.",
			},
			{
				question: "What Is Usually Covered In Your WordPress Maintenance Contract?",
				answer: "Perform WordPress version updates, regular backups of your WordPress website files and database, scan your website for any malware attack and clean up, check and perform speed optimization, solve any bugs that we find or you report to us, and help you in updating content-pictures, SEO monitoring and all such important support tasks are covered in our WordPress maintenance package.",
			},
			{
				question: "How Long Does It Take To Get The Changes Done After I Submit A Maintenance/Support Request?",
				answer: "If you purchase a WordPress maintenance plan with us, We normally complete maintenance requests in max 2 days. In case of any important update requests, We act on them within 24 hours.",
			},
			{
				question: "What If An Update Breaks Our Business Website?",
				answer: "If an update breaks the design or functionality of your WordPress website, we will roll back the update. We will perform the updates on a test server first, conduct detailed testing and then make the changes on your live website during your off business hours so that your end-users do not face any issues while using the website.",
			},
			{
				question: "Why Should I Hire IceCube Digital For My WordPress Website Maintenance?",
				answer: "We are a certified WordPress design & development agency with 14+ years of experience in building and maintaining groundbreaking websites and portals with the WordPress platform. Customer satisfaction is the end goal of everything that we do.",
			},
			{
				question: "Why is regular WordPress Maintenance important?",
				answer: "Regular maintenance helps to keep your website secure, free from bugs, and compatible with the technologies. It guarantees a user experience improves SEO rankings and minimizes the risk of data loss.",
			},
			{
				question: "How often should a WordPress website be updated?",
				answer: "Generally speaking, it is recommended to update WordPress websites whenever there is a release for WordPress itself or themes and plugins. These updates often include security enhancements and new functionalities that enhance your site’s performance and security.",
			},
			{
				question: "Will my website experience downtime during maintenance?",
				answer: "At Icecube Digital Agency we make every effort to maintain 100% uptime for your website. We schedule maintenance activities during low-traffic hours to reduce any impact, on your visitors.",
			},
			{
				question: "Can I handle WordPress Maintenance on my own?",
				answer: "While certain upkeep tasks can be handled solo some may require technical expertise. Our professional maintenance service, at Icecube Digital ensures that every aspect of your website receives care allowing you to dedicate your time to your business.",
			},
			{
				question: "How does your WordPress Maintenance Service improve site security?",
				answer: "We implement security measures regularly update your website and monitor for any activities. Our proactive approach helps prevent security breaches and maintains the safety of your website.",
			},
			{
				question: "What if my website has already been hacked?",
				answer: "Our team has the expertise to handle compromised WordPress sites. We can clean up your website, restore it from a backup, and enhance its security to prevent attacks.",
			},
			{
				question: "What kind of support do I get with your WordPress Maintenance Service?",
				answer: "Our knowledgeable support team is on hand to help with any issues or questions regarding your WordPress site. Whether it’s problems or simple inquiries we are here to assist you.",
			},
			{
				question: "How can I sign up for your WordPress Maintenance Services?",
				answer: "Signing up for our WordPress Maintenance Services is simple. You can easily fill out the contact form on our website and we will assist you with the plan that fits best for you.",
			},
		],
	},
