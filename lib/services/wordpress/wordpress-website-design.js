	...
	topIconBox: {
		...
		items: [
			...
			},
			{
				...
				title: "SEO Services",
				body: ["Our ", { text: "WordPress SEO service", href: "/wordpress-seo-service/" }, " specialists will optimize your website to make it easier for prospective customers to find you on Google and other search engines. We use the best SEO techniques and help you achieve outstanding results."],
			},
			{
		...
		cards: [
			...
			},
			{
				...
				listItems: [
					...
					{ title: "Customization with AI Assistant:", parts: ["If you need some quick changes, then just prompt the built-in AI assistant. From adding a call-to-action to adjusting layouts, updates happen instantly — no developer required."] },
