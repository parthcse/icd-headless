...
const EcommerceSeoServices = {
	...
	textBox: {
		...
		title: "Ecommerce SEO?",
		paragraphs: [
			"eCommerce SEO optimization refers to using the best practices to fine-tune your website to meet the requirements at the top of search engine results. Also, it ensures you update your website content regularly so the customers are aware of what services/products your brand provides and your target audience finds what they are looking for.",
			"Search engine algorithms are updated in a timely manner, so it is essential to update your website continuously to meet search engine requirements and maintain the top ranks. For example, the site structure should be simple; the webpage loading time should lie between 2-10 seconds; every page of your website should be accessible within a few intuitive clicks, and others.",
			"As an eCommerce website, it is tough to target every keyword, so it is best to conduct keyword research based on four factors: volume, competition, relevancy, and intent. The ultimate keyword would be looking for keywords with high volume but low competition.",
		],
		contentAlign: "center",
	},
	...
	clientTrust: {
		...
		items: [
			...
			{
				icon: "/images/seo.svg",
				name: "Technical SEO Audit and Repair",
	...
	textBoxQuaternary: {
		...
		paragraphs: [
			"It is one of the common questions that is asked by many, and as a reputed and experienced SEO agency for eCommerce, we tell our clients it usually takes 4-6 months for any SEO strategy to work and reflect the results. However, there are circumstances where the time period may change, as the SEO strategy for a brand-new website may take around 12 months to reflect results. In some cases, like with a well-established, may witness the result within 1-2 months. Nonetheless, the results will improve with time.",
		],
		contentAlign: "center",
	},
