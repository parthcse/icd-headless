...
const WhiteLabelSeoServices = {
	...
	portfolio: {
		...
		// TODO: replace with the real WordPress portfolio post IDs (Devlin Funeral Home, etc.)
		postIds: [71, 65, 73],
	...
	// Figma "Get SEO Audit Report" — form + image (common SEO audit form).
	seoAuditForm: {
	...
	// Figma "Pricing Plans" → ServicesTableSeoPlans.js
	tableSeoPlans: {
