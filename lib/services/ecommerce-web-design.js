...
const EcommerceWebsiteDesignServices = {
	...
	textBoxSecondary: {
		...
		paragraphs: [
			"With our Ecommerce website design services, we acknowledge the significance of users to promote better engagement. That's why we adopt a customer-focused approach to website redesigns, ensuring that your online store is optimized to meet the needs of your target audience.",
			[
				"Our ",
			...
			"Trust us to deliver a customer-focused Ecommerce website redesign that will set you apart from the competition and take your business to the next level.",
		],
		contentAlign: "center",
		ctaLabel: "Request A Free Quote",
		ctaHref: "#",
