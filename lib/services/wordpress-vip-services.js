...
const WordPressVipServices = {
		...
		items: [
			{
				...
				name: "Flexible To Match Your Architecture",
			...
			{
				icon: "/images/content-management.svg",
				name: "Superior Content Management",
	...
	iconCardsSecondary: {
		...
		title: "VIP Platform",
		subtitles: ["To unlock the full potential of your website a solid base is a necessity. WordPress VIP provides a huge set of features for security, scalability, and good performance. Let's look at some of the features of WordPress VIP that make it unmatchable."],
		items: [
			{
				name: "Enterprise-Grade Integrations and Plugins",
	...
	featureCards: {
		...
		items: [
			...
			},
			{
				...
				name: "Scalability & Enhanced Performance",
		...
		items: [
			{
				...
				answerHtml: `<p>Possible! Yes, you can convert your standard WordPress website into a WordPress VIP website. The migration methods could contain some technical considerations, and our expert team could perform the transition seamlessly.</p><p>Here's the breakdown of how we will be performing the migration:</p><ul><li><strong>Small and simple website:</strong> We will be handling the transition manually. During the migration, we would be ensuring all the functionality and content is transferred without any fail.</li><li><strong>Large website:</strong> For this the manual process might lead us to miss out on content during the transfer. We would prefer to use the WordPress VIP Command Line Interface (CLI) tool for accurate transition.</li></ul><p>The size of your website will only determine the method we will be using to migrate. We ensure to work closely for a smooth process just like we did for many other businesses before. Our expert team will brief you about our process in a detailed manner before the start of the migration.</p>`,
			},
			{
				question: "Is WordPress VIP a compatible choice for an e-commerce website?",
				answer: "Absolutely. WordPress VIP is highly compatible with e-commerce websites. It supports WooCommerce and other commerce integrations while delivering the enterprise-grade performance, security, and uptime that high-traffic online stores demand. Whether you're running flash sales or handling thousands of concurrent shoppers, WordPress VIP can scale effortlessly.",
			},
			{
				question: "Can WordPress VIP be hosted on AWS (Amazon Web Services) or Azure?",
				answer: "WordPress VIP is hosted on its own managed cloud infrastructure built on top of industry-leading cloud providers. The platform is engineered for reliability and global performance. Our team can guide you through the infrastructure setup and ensure your deployment aligns with your compliance and performance requirements.",
			},
			{
				question: "What type of personal information does WordPress VIP content analytics capture?",
				answer: "WordPress VIP's analytics tools are designed with privacy in mind and comply with major data protection regulations including GDPR and CCPA. By default, analytics capture behavioral data such as page views and traffic patterns — without storing personally identifiable information. Your privacy and compliance posture remains fully in your control.",
			},
			{
				question: "Can you briefly talk about the deployment process in WordPress VIP?",
				answer: "WordPress VIP uses a Git-based deployment workflow. All code changes are pushed to a VIP-hosted repository, reviewed for quality and security, and then deployed to the live environment. This process ensures consistency, auditability, and zero-downtime releases. Our development team manages the entire deployment pipeline so your site updates smoothly and safely.",
			},
		],
	},
