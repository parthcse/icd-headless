...
const DigitalMarketingService = {
	...
	imageText: {
		...
		paragraphs: [
			...
			[
				...
				{ text: "seo marketing agency in Las Vegas", href: "/seo-search-engine-optimization/" },
	...
	comparisonTable: {
		...
		rows: [
			[
				"Channel Expertise",
				"✓ Specialized in Digital Ads & SEO — Focused efforts deliver maximum impact",
				"✗ Generalist Approach — Spread thin across too many platforms",
			],
			[
				"Client Service",
				"✓ Work Directly with Experts — Senior specialists guide your strategy",
				"✗ Outsourced & Junior Teams — Execution often handled by less experienced staff",
			],
			[
				"KPI Alignment",
				"✓ Revenue-Driven Metrics — Performance tied directly to ROI",
				"✗ Surface-Level Metrics — Emphasis on vanity metrics like impressions or clicks",
			],
			[
				"Strategy Customization",
				"✓ Tailored to Your Business — No two campaigns are alike",
				"✗ One-Size-Fits-All — Cookie-cutter strategies applied to every client",
			],
			[
				"Speed To Market",
				"✓ Rapid Campaign Launches — Streamlined processes for quick deployment",
				"✗ Slow Execution — Prolonged onboarding and delayed rollouts",
			],
			[
				"Reporting & Transparency",
				"✓ Clear, Actionable Reporting — Full visibility into what's working",
				"✗ Opaque & Overcomplicated Reports — Hard to tie results to real business goals",
			],
		],
	},
	...
	pricing: {
		...
		plans: [
			{
				name: "Starter",
				description: "Affordable entry-level digital marketing for businesses just getting started online.",
			...
			{
				name: "Growth",
				description: "Scale your business with integrated multi-channel marketing campaigns.",
				ctaLabel: "Get a Free Quote",
				ctaHref: "#",
				features: [
			...
			{
				name: "Premium",
				description: "Full-service digital marketing coverage for growing brands and eCommerce stores.",
				ctaLabel: "Get a Free Quote",
				ctaHref: "#",
				features: [
			...
			{
				name: "Enterprise",
				description: "End-to-end strategy and dedicated support for large-scale organizations.",
				ctaLabel: "Get a Free Quote",
				ctaHref: "#",
				features: [
	...
	featureCards: {
		...
		items: [
			...
			{
				icon: "/assets/icons/chatbots.svg",
			...
			},
			{
				...
				name: "Delivering Promising Results",
			...
			},
			{
				...
				name: "Custom Digital Marketing Approach",
	...
	cta: {
		...
		subtitle: "Partner with Icecube Digital for data-driven digital marketing strategies that deliver real, measurable results for your business.",
		ctaLabel: "Get a Free Quote",
		ctaHref: "#",
		btnArrow: BTN_ARROW,
	},
		...
		items: [
			{
				...
				answer: "Absolutely. Every brand requires an online presence to reach modern consumers. Whether you're a startup or an established enterprise, a continuous and thorough digital marketing strategy helps you attract qualified leads, build brand trust, and grow revenue consistently. Any business that wants visibility, traffic, and conversions can benefit from professional digital marketing.",
			},
			{
				question: "What digital marketing services would suit my business?",
				answer: "The right mix depends on your goals, industry, and target audience. An eCommerce brand may prioritize SEO and paid shopping campaigns, while a B2B company might benefit more from content marketing and email automation. Our team starts with a thorough audit of your current presence and recommends a custom strategy tailored to your specific business objectives.",
			},
			{
				question: "Is digital marketing better than traditional marketing?",
				answer: "Digital marketing offers measurable ROI, precise audience targeting, real-time adjustments, and lower cost-per-acquisition compared to traditional channels like print or TV. It also allows two-way engagement with your audience. While both have their place, digital marketing is generally more scalable, trackable, and cost-effective for most businesses today.",
			},
			{
				question: "What distinguishes digital advertising from digital marketing?",
				answer: "Digital advertising refers specifically to paid placements — such as Google Ads, social media ads, or display banners — where you pay for visibility. Digital marketing is a broader discipline that encompasses both paid and organic strategies including SEO, content marketing, email campaigns, social media management, and analytics. Advertising is one component within the wider digital marketing framework.",
			},
			{
				question: "Why does SEO pricing vary so much?",
				answer: "SEO pricing depends on factors like the competitiveness of your industry, the current state of your website, the number of target keywords, and the scope of work required — from technical audits to link building. Agencies also differ in experience, team size, and deliverables. We offer transparent, customized SEO packages aligned with your goals and budget.",
			},
			{
				question: "How long does it take to see results from digital marketing?",
				answer: "It varies by channel. PPC campaigns can generate traffic and leads within days of launch. SEO typically shows meaningful improvements in 3–6 months as search engines index and rank optimized content. Content marketing and email campaigns build momentum over time. We set realistic timelines during onboarding and provide regular reporting so you always know where you stand.",
			},
			{
				question: "Can small businesses benefit from digital marketing?",
				answer: "Yes — digital marketing actually levels the playing field for small businesses. With the right strategy, a small business can outrank larger competitors in local search, build a loyal social following, and generate leads through targeted advertising — all within a budget that suits them. Our flexible packages are specifically designed to deliver results at every business size.",
			},
			{
				question: "What is the difference between SEO, PPC, and SMM?",
				answer: "SEO (Search Engine Optimization) improves your website's organic visibility in search results over time. PPC (Pay-Per-Click) is a paid advertising model where you pay for each click on your ad, delivering immediate traffic. SMM (Social Media Marketing) focuses on building brand awareness and engagement across social platforms through organic posts and paid campaigns. Used together, they form a comprehensive digital marketing strategy.",
			},
			{
				question: "Can digital marketing help improve brand reputation online?",
				answer: "Yes. Consistent content marketing, proactive social media engagement, positive customer reviews, and transparent communication all contribute to a stronger online reputation. Our team also monitors brand mentions and helps address negative feedback promptly. A well-executed digital marketing strategy builds trust and positions your brand as an authority in your industry.",
			},
			{
				question: "How do you measure the success of digital marketing campaigns?",
				answer: "We track key performance indicators (KPIs) aligned with your goals — such as organic traffic growth, conversion rate, cost per lead, return on ad spend (ROAS), email open rates, and keyword rankings. We set up advanced tracking via Google Analytics, GA4, and platform-native dashboards, and deliver monthly reports with actionable insights to continuously improve campaign performance.",
			},
		],
	},
