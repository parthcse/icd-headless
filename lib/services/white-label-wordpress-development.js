...
const WhiteLabelWordPressDevelopment = {
  ...
  topIconBoxSecondary: {
    ...
    items: [
      { icon: "/assets/icons/gear.svg", title: "Custom WordPress Website Development", body: "We provide WordPress website development by building fully customized WordPress websites tailored to your client's business goals." },
      { icon: "/assets/icons/multidevice.svg", title: "Theme Development & Customization", body: "Our team creates or customizes WordPress themes to match your client's brand identity." },
      { icon: "/assets/icons/sliders.svg", title: "Plugin Development & Integration", body: "From custom plugin development to third-party integrations, we ensure seamless functionality." },
      { icon: "/assets/icons/code-monitor.svg", title: "WooCommerce Development", body: "We develop and optimize WooCommerce stores with smooth checkout experiences." },
      { icon: "/assets/icons/timer.svg", title: "Website Speed Optimization", body: "Improve loading speed, Core Web Vitals, and overall performance for better engagement." },
      { icon: "/assets/icons/shield-check.svg", title: "Website Maintenance & Support", body: "Ongoing updates, security monitoring, and performance checks to keep sites running smoothly." },
      { icon: "/assets/icons/payment-cycle.svg", title: "Payment Gateway Integration", body: "Secure and reliable payment integrations like Stripe and PayPal for seamless transactions." },
    ],
  },
  ...
  featureCards: {
    ...
    items: [
      { icon: "/assets/icons/elementor-icon.svg", title: "Elementor", body: "Elementor allows for highly customizable designs with drag-and-drop simplicity. Our team uses its advanced features to craft visually appealing, fast-loading websites that can be easily updated. It's a favorite among clients for its flexibility and user-friendly interface." },
      { icon: "/assets/icons/beaver-builder-icon.svg", title: "Beaver Builder", body: "Beaver Builder offers a powerful yet straightforward page-building experience. We use it to create responsive designs that load quickly across devices. Its clean code and reliable performance make it an ideal choice for scalable, high-quality websites." },
      { icon: "/assets/icons/divi-icon.svg", title: "Divi Builder", body: "Known for its all-in-one design capabilities, Divi Builder enables rich, dynamic web pages. We utilize its wide range of layouts and design modules to build visually stunning websites that are easily customizable, giving you a unique edge in the market." },
      { icon: "/assets/icons/wpbakery-icon.svg", title: "WPBakery Builder", body: "WPBakery's frontend and backend editing options provide versatility for developers and end-users alike. We harness its flexibility to create custom, highly responsive websites that meet both aesthetic and functional requirements, perfect for more complex designs." },
      { icon: "/assets/icons/gutenberg-icon.svg", title: "Gutenberg", body: "Gutenberg offers a block-based editing experience, ideal for creating simple yet powerful layouts. Our team leverages Gutenberg's native integration with WordPress to build lightweight, fast-loading sites while ensuring easy content updates and management for your clients." },
      { icon: "/assets/icons/siteorigin-icon.svg", title: "Site Origin Builder", body: "Site Origin Builder is known for its simplicity and reliability. As a white-label WordPress agency, we use this builder to design responsive websites with clean layouts. Its widget-based system provides flexibility, allowing us to tailor each site to specific business needs with minimal overhead." },
      { icon: "/assets/icons/be-builder-icon.svg", title: "BE Builder", body: "BE Builder offers a highly visual approach to website creation. We leverage its intuitive design interface to quickly build engaging, responsive sites, ensuring that clients can easily manage and modify content while maintaining a professional look and feel." },
      { icon: "/assets/icons/avada-builder-icon.svg", title: "Avada Builder", body: "Trusted by over 900,000 businesses, Avada Builder's powerful drag-and-drop interface, Fusion Elements library, and live front-end editing let our team craft feature-rich, conversion-focused websites with precision — delivering premium results for your clients every time." },
    ],
  },
