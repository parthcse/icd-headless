...
const WhiteLabelWordPressDevelopment = {
	...
	portfolio: {
		...
		subtitle:
			"See how agencies scaled faster and delivered better results with our white-label WordPress support.",
		postIds: [71, 65, 73],
		...
		items: [
			{
				...
				answer:
					"White label WordPress development allows us to build WordPress websites under your agency's name. We handle the technical work while you focus on client relationships and growing your business.",
			},
			{
				question: "Do you work under our brand name?",
				answer:
					"Yes, absolutely. We operate as an extension of your team and never reveal our identity to your clients. All deliverables, communications, and documentation can be customized with your branding.",
			},
			{
				question: "What services do you offer?",
				answer:
					"We offer custom WordPress development, theme and plugin development, WooCommerce development, speed optimization, maintenance, and payment gateway integration — all under your brand.",
			},
			{
				question: "How do you communicate and manage projects?",
				answer:
					"We use your preferred project management tools and communication channels. Our team provides regular updates and progress reports to keep you aligned at every stage.",
			},
			{
				question: "How long does it take to build a website?",
				answer:
					"Timelines depend on project scope. A standard WordPress site typically takes 2–4 weeks, while more complex builds may take longer. We always work to meet your client's deadlines.",
			},
			{
				question: "How do you ensure quality and deadlines?",
				answer:
					"We follow a structured QA process with dedicated testing for performance, security, and responsiveness. Dedicated project managers ensure milestones are met on time.",
			},
			{
				question: "Will we own the website?",
				answer:
					"Yes. All code, assets, and deliverables are fully owned by your agency and/or your clients. We have no claims over any work we produce for you.",
			},
			{
				question: "Can you work on existing websites?",
				answer:
					"Absolutely. We take on redesigns, migrations, performance improvements, and ongoing maintenance for existing WordPress websites.",
			},
			{
				question: "Do you provide SEO support?",
				answer:
					"Yes. We offer technical SEO services including on-page optimization, speed improvements, and structured data as part of our white-label offerings.",
			},
			{
				question: "Do you sign NDA and ensure confidentiality?",
				answer:
					"Yes. We sign NDAs with every partner agency and maintain strict confidentiality. Your clients will never know we exist — your brand stays front and center.",
			},
		],
	},
