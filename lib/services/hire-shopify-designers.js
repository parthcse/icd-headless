...
const HireShopifyDesigners = {
	...
	// Figma "Hire Shopify Designer with Transparent Pricing & Rapid Delivery" — image left, text right.
	imageText: {
	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "A Shopify expert web designer specializes in the Shopify platform — its themes, Liquid templating, apps, and checkout — so they understand exactly how to build for performance, conversions, and Shopify's best practices. A general web designer may lack this platform-specific knowledge, which can lead to slower, less optimized stores. Our Shopify specialists bring proven, platform-focused expertise to every project.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "What ongoing support do you provide after the store launch?",
				answer: "After launch, we provide ongoing support including design updates, bug fixes, performance and security monitoring, theme and app updates, and feature enhancements. Whether you need small tweaks or larger redesigns, our team stays available to keep your store fresh, secure, and running smoothly.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "Can you customize a pre-built Shopify theme?",
				answer: "Yes. We offer expert customization of pre-built Shopify themes — adjusting colors, fonts, layouts, sections, and functionality to match your brand and goals. This lets you benefit from a ready-made foundation while still getting a unique, on-brand store tailored to your business.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "How do you ensure my Shopify store is secure and fast?",
				answer: "We optimize theme code, images, apps, and scripts to improve Core Web Vitals and loading speed, and we follow security best practices such as SSL, secure payment gateways, and regular updates. Combined with Shopify's reliable, PCI-compliant infrastructure, this keeps your store fast, secure, and trustworthy for your customers.",
			},
		],
	},
