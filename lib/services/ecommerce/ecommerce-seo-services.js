	...
	topIconBox: {
		...
		items: [
			...
			},
			{
				...
				body: ["Before beginning any work, our ", { text: "professional SEO services", href: "/seo-search-engine-optimization/" }, " for eCommerce websites include a thorough and stringent SEO audit to understand what your website requires. Besides, you can hire our experts for a one-time service, where the team will find the gaps during the audit and repair the technical SEO stuff at an affordable cost."],
			},
			{
