...
const HireEcommerceDevelopers = {
	...
	plainText: {
		...
		blocks: [
			...
			{ type: "p", parts: [
				...
				{ text: "eCommerce Website Development company,", href: "/ecommerce-website-development-services/" },
	...
	testimonials: {
		...
		testimonialSlug: "chris-and-sandra",
	},
	...
	imageText: {
		...
		paragraphs: [
			...
			[
				{ bold: "Hiring a website designer" },
				" can tailor your site to highlight upsell opportunities without disrupting the customer’s experience. By strategically placing relevant products or special offers, you can boost sales without feeling overly promotional.",
			],
	...
	imageTextSecondary: {
		...
		paragraphs: [
			...
			["Our ", { bold: "ecommerce web development" }, " experts focus on creating designs that not only look great but are easy to navigate. From product categories to search filters, every element is crafted to guide users effortlessly toward the checkout."],
		...
		items: [
			{
				...
				answer: "Based on your initial ideas and references, our expert eCommerce website designers’ team can develop wireframes and mock-ups for page designs. With your feedback on the initial mock-ups, we work on the revisions. We offer unlimited revisions and we won’t be happy unless you are satisfied with the design.",
			},
			{
			...
			},
			{
				...
				answer: "Yes, we provide a free one month of bug fixing support. Later, you can opt for our monthly or yearly eCommerce website maintenance package to keep your website up to date.",
			},
			{
				question: "I already have a website, can you update it?",
				answer: "If you have a website that is out of date and not generating sales, we can help to redesign it as per current design trends. The price and timeline for such a project can be decided after a thorough review of your existing website.",
			},
			{
			...
			},
			{
				...
				answer: "The cost of building a website really depends on the time it takes to design and development of the website. It takes longer to build a webshop with custom features than a simple order processing website. We offer industry-specific solutions to keep the cost as minimum as possible.",
			},
			{
				question: "Will my website work well on smartphones and tablets?",
				answer: "Every website we build is mobile responsive. The majority of people are accessing the web using small screen devices these days so it’s important that your website provides the best user experience on mobile phones and tablets. Our design team uses a mobile-first strategy while designing eCommerce websites.",
			},
			{
				question: "What if I find any issues after the website is live?",
				answer: "We have a solid testing process in place for all our website design and development projects so there is no chance of errors but in case of any issues, We offer 1 month of free bug fixing support so you are all covered.",
			},
			{
				question: "Who will be my point of contact during project tenure?",
				answer: "Our eCommerce development project manager will be in constant communication with you via your preferred communication channel. We use email, phone, Skype, and other project management tools such as Trello, Slack, etc to keep our valued customers updated about the project progress.",
			},
			{
