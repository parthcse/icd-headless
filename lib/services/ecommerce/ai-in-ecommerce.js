...
const AiInEcommerceSolutions = {
		...
		cards: [
			{
				blocks: [
					...
					{ type: "ul", items: [
						{ title: "Hyper-personalization", text: "Delivers tailored product recommendations based on user behavior and preferences." },
						{ title: "24/7 Customer Support", text: "AI chatbots handle inquiries instantly, improving response times and satisfaction." },
						{ title: "Smarter Inventory Management", text: "Predicts demand and optimizes stock levels to reduce overstock and shortages." },
						{ title: "Dynamic Pricing", text: "Adjusts prices in real time based on demand, competitor pricing, and user data." },
						{ title: "Fraud Detection", text: "Identifies unusual patterns and transactions using anomaly detection algorithms." },
						{ title: "Data-Driven Decisions", text: "Uses predictive analytics to forecast trends, customer behavior, and revenue potential." },
						{ title: "Improved Search and Navigation", text: "Enhances site search with AI-powered visual and voice search features." },
					]},
					{ type: "p", parts: [
						"With these many benefits, who wouldn't like to try ",
						{ text: "AI integration services", href: "/ai-integration-services/" },
						" that can boost ROI in the long term? Companies that utilized AI-powered marketing automation have witnessed up to a 251% ROI.",
					] },
				],
			},
		],
	...
	topIconBox: {
		...
		subtitles: [
			[
				...
				{ text: "eCommerce development agency,", href: "/ecommerce-website-development-services/" },
	...
	cta: {
		text: "Make AI your team member that never sleeps, never gets tired, and works every time with full precision!",
