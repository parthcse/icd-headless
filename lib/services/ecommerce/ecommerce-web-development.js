...
const EcommerceWebsiteDevelopmentServices = {
	...
	plainText: {
		...
		blocks: [
			{ type: "p", parts: [
				"We are one of the most compatible USA based ",
				{ text: "ecommerce website developers", href: "/hire-ecommerce-designers-developers/" },
				", designers, and strategists, with a laser-sharp focus on making your online store a huge success. Whether you're launching a brand new ecommerce website, re-designing your existing website or looking to revamp your online presence, you've come to the right place.",
			] },
			...
			{ type: "p", parts: [
				{ bold: "Here's our core ecommerce mantra" },
				" – \"Boost your brand value while increasing your product sales.\"",
			] },
		],
	...
	leftIconBox: {
		...
		subtitle:
			"As a top eCommerce development company, Icecube Digital has 14+ years of experience working across various platforms, like Shopify, Magento, and WooCommerce.",
		items: [
			{
		...
		items: [
			{
				...
				body: [
					"Usability is critical for success of any eCommerce website. Our ",
					{ text: "eCommerce website design", href: "/ecommerce-website-design-services/" },
					" team creates all websites with usability in mind to improve the performance of your website and increase your chances of success.",
				],
			},
			{
				icon: "/assets/icons/square-cursor.svg",
	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "Yes, Our development and SEO team works together to build an user and SEO-friendly website for your business. We take care of all the important eCommerce SEO aspects while building websites.",
			},
		],
	},
