...
const AiInEcommerceSolutions = {
	...
	topIconBox: {
		...
		items: [
			...
			{ icon: "/assets/icons/smart.svg", title: "Smart Logistics", body: "AI takes the chaos out of fulfillment. It routes orders efficiently, predicts delivery windows, and optimizes warehouse operations with computer vision and real-time tracking. Faster, cheaper, smarter shipping minus the logistics headaches." },
	...
	leftIconBoxSecondary: {
		...
		items: [
			...
			{ icon: "/assets/icons/chatbots.svg", title: "Support that sticks around", body: "We are your AI integration partner, not just a vendor. We work as your extended team. From strategy to implementation and beyond, our AI SEO and AI integration team stays connected to ensure your AI evolves as your business does." },
			{ icon: "/assets/icons/income.svg", title: "Real results, real experience", body: "We've delivered scalable AI solutions for brands across industries, helping them personalize experiences, automate operations, and improve performance, with measurable outcomes that speak for themselves." },
			...
			{ icon: "/assets/icons/time.svg", title: "Trusted by top brands", body: "Our work speaks for itself. Leading eCommerce brands trust Icecube Digital to deliver reliable, intelligent, and scalable AI solutions that fuel real growth." },
		],
	},
