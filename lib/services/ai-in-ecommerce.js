...
const AiInEcommerceSolutions = {
	...
	iconCards: {
		...
		items: [
			...
			{ icon: "/assets/icons/sliders.svg", name: "AI-Powered Personalization", body: "No more one-size-fits-all. AI tracks user behavior across devices to tailor everything—from homepage banners to email offers. It's like giving each shopper their own concierge, powered by real-time machine learning and deep customer data." },
			{ icon: "/assets/icons/chatbots.svg", name: "Chatbots & Virtual Assistants", body: "AI chatbots can answer your customers' queries day and night without any strain. With NLP and intent recognition, they answer FAQs, recommend products, process returns, and escalate the emergency or complex situation to your customer support executive." },
			{ icon: "/assets/icons/payment-cycle.svg", name: "Dynamic Pricing", body: "AI doesn't guess, but it calculates. By analyzing demand, competition, user behavior, and even time of day, dynamic pricing models optimize your prices on the fly to boost conversions and keep margins healthy. Smart, sneaky, and profitable." },
			{ icon: "/assets/icons/predictive.svg", name: "Predictive Analytics", body: "Want to know what your customers will want next week? Predictive analytics sifts through past data to forecast trends, customer churn, lifetime value, and more. The machine learning algorithm is doing its future-telling thing." },
			{ icon: "/assets/icons/smart.svg", name: "Smart Logistics", body: "AI takes the chaos out of fulfillment. It routes orders efficiently, predicts delivery windows, and optimizes warehouse operations with computer vision and real-time tracking. Faster, cheaper, smarter shipping minus the logistics headaches." },
			{ icon: "/assets/icons/detection.svg", name: "AI Fraud Detection", body: "Every suspicious pattern gets flagged instantly. AI fraud systems use anomaly detection, behavioral analysis, and historical data to catch fake transactions before they cause damage—no cape, but definitely your store's silent superhero." },
			{ icon: "/assets/icons/voice.svg", name: "Voice Search Optimization", body: "Find me red sneakers under $100 – the users find it easy to look for products with their voice assistants, like Siri. AI-powered voice search understands natural language, accents, and intent. It turns casual voice queries into accurate results, keeping your store one step ahead in a hands-free world." },
			{ icon: "/assets/icons/inventory.svg", name: "Inventory Management", body: "No more stockouts or dead inventory. AI tracks sales velocity, seasonal shifts, and real-time trends to automate restocking and predict demand. Besides, the computer vision systems can keep track of the surroundings in real-time and alert if they find any errors or defects. Like, computer vision can quickly find out the expired products, and your team can remove them from the inventory." },
			...
			{ icon: "/assets/icons/shopping.svg", name: "AR Shopping with AI", body: "AI meets augmented reality to bring the try-before-you-buy experience online. From virtual try-ons to room previews, computer vision + real-time rendering = fewer returns and way more \"add to cart\" moments." },
			{ icon: "/assets/icons/trusted-value.svg", name: "Customer Lifetime Value Prediction", body: "Not all customers are created equal. AI models calculate lifetime value by analyzing purchase frequency, basket size, and behavior trends, so you can spend smarter, target better, and retain the ones worth keeping." },
		],
	},
	...
	featureCards: {
		...
		items: [
			{ icon: "/assets/icons/count-1.svg", name: "Define Your Business Goals", body: "Before adopting any AI solution, be clear about what you want to achieve—boosting sales, reducing churn, automating support, or personalizing experiences. Clear goals help guide the right use cases and ensure your investment drives real results." },
			{ icon: "/assets/icons/count-2.svg", name: "Audit and Organize Your Data", body: "AI thrives on clean, structured, and relevant data. Audit your existing databases, remove redundancies, and categorize key metrics like customer behavior, transactions, and product info to give AI models the fuel they need to work effectively." },
			{ icon: "/assets/icons/count-3.svg", name: "Choose the Right AI Tools", body: "Select AI tools that align with your business size, goals, and existing tech stack. Whether it's a recommendation engine, chatbot, or analytics suite, look for scalability, integration capabilities, and proven success in the eCommerce space." },
			{ icon: "/assets/icons/count-4.svg", name: "Integrate AI with the Platform", body: "Once chosen, integrate your AI tools with your eCommerce platform, CRM, and marketing stack. Smooth integration ensures real-time data flow and enables AI to power everything from personalization to logistics without breaking the user experience." },
			{ icon: "/assets/icons/count-5.svg", name: "Train Your Team", body: "AI tools need more than plug-and-play. They need people who can manage, interpret, and adjust them. Upskill your marketing, product, and support teams to collaborate with AI systems and use insights for smarter decision-making." },
			{ icon: "/assets/icons/count-6.svg", name: "Monitor & Optimize Continuously", body: "AI is not a set-it-and-forget-it solution. Continuously track performance, review results, and refine your models based on real-world feedback. Regular optimization ensures your AI evolves with market trends, customer behavior, and business growth." },
		],
	...
	featureCardsSecondary: {
		...
		items: [
			{ icon: "/assets/icons/inventory.svg", name: "We understand eCommerce inside out", body: "With years of experience building and optimizing online stores, we know what drives conversions, loyalty, and growth. Our AI solutions are built on a foundation of real eCommerce insight, not guesswork or one-size-fits-all playbooks." },
			{ icon: "/assets/icons/grid.svg", name: "Easy integration with your existing setup", body: "No need to rebuild everything. Our solutions integrate seamlessly with major eCommerce platforms, CRMs, and marketing tools. It minimizes disruption while maximizing impact." },
			{ icon: "/assets/icons/gear.svg", name: "Custom solutions for your business", body: "Your brand is unique, and so are your challenges. We craft AI strategies and models specifically for your workflows, customer base, and KPIs, so every feature adds value from day one." },
			{ icon: "/assets/icons/like.svg", name: "AI that actually works for you", body: "We don't do shiny tools that sit unused. Our AI systems are practical, proven, and aligned with your business goals. It drives automation, boosts personalization, and turns data into decisions that matter." },
			{ icon: "/assets/icons/chatbots.svg", name: "Support that sticks around", body: "We are your AI integration partner, not just a vendor. We work as your extended team. From strategy to implementation and beyond, our AI SEO and AI integration team stays connected to ensure your AI evolves as your business does." },
			{ icon: "/assets/icons/income.svg", name: "Real results, real experience", body: "We've delivered scalable AI solutions for brands across industries, helping them personalize experiences, automate operations, and improve performance, with measurable outcomes that speak for themselves." },
			{ icon: "/assets/icons/comment.svg", name: "Simple, clear communication", body: "We don't bury you in tech jargon. Our approach is transparent, collaborative, and focused on making sure you always know what's happening and why it matters." },
			{ icon: "/assets/icons/time.svg", name: "Trusted by top brands", body: "Our work speaks for itself. Leading eCommerce brands trust Icecube Digital to deliver reliable, intelligent, and scalable AI solutions that fuel real growth." },
		],
	},
