...
const Magento2Development = {
  ...
  clientSuccess: {
    ...
    // TODO: replace with the real WordPress `portfolio` post IDs for these case studies (Baby Kingdom, Visor, Respirator Shop)
    postIds: [71, 65, 73],
  ...
  clientTrust: {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Magento 2 Mobile App Development",
      ...
      },
      {
        ...
        name: "Magento 2 Module Development",
  ...
  qualityWebsites: {
    ...
    items: [
      {
        icon: "/images/services-offers-2.svg",
        name: "Open And Flexible Architecture",
    ...
    items: [
      {
        ...
        name: "Conversion and Growth Focused",
