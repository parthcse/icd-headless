...
const HireEcommerceDevelopers = {
	...
	clientRetention: {
		...
		image: "/images/hire-ecommorce-developers-left.png",
		imageAlt: "",
		paragraphs: [
	...
	clientRetentionSecondary: {
		...
		image: "/images/hire-ecommorce-developers-right.png",
		imageAlt: "",
		imagePosition: "right",
		paragraphs: [
	...
	clientTrust: {
		...
		items: [
			...
			},
			{
				...
				name: "Platform Upgrade & Migration",
			...
			{
				icon: "/images/services-offers-7.svg",
			...
			},
			{
				...
				name: "Plugins & Module Development",
		...
		items: [
			{
				...
				body: [
					...
					"So far, we have helped a number of companies across the world turn their websites into sales platforms with in-depth Magento customization and refinement services. If you have made the smart decision of redesigning your website or want to develop it from the core, then get in touch with us today.",
				],
			},
			{
				...
				body: [
					...
					"Whether you are looking for Shopify customization services, integration services, migration services, or theme development, our eCommerce developers are agile in delivering to any industry vertical. In fact, our dedicated Shopify team strives hard to provide powerful and dynamic eCommerce solutions.",
				],
			},
			{
				...
				body: [
					...
					"Further, our WooCommerce team has hands-on experience in handling different WooCommerce requirements, including plugin customization, theme customization, payment gateway integration, and more.",
				],
			},
		],
	},
		...
		items: [
			{
				...
				name: "The most cost effective option",
			...
			},
			{
				...
				name: "Boost Overall Productivity",
			...
			},
			{
				...
				name: "Access A Variety Of Skills & Expertise",
