...
const whiteLabelWordpress = {
  slug: "white-label-wordpress",
  pageTitle: "White Label WordPress Development | Icecube Digital",
    ...
    badges: [
      {
        name: "Google",
        rating: "5.0",
        description: "Rated 5.0 Stars by Clutch – Exceptional service with top-tier client satisfaction.",
        icon: "google",
      },
      {
        name: "Glassdoor",
        rating: "5.0",
        description: "5.0 Stars on Glassdoor – Our team values a positive and thriving work environment.",
        icon: "glassdoor",
      },
      {
        name: "Goodfirms",
        rating: "4.9",
        description: "4.9 Stars on GoodFirms – Recognized for delivering outstanding results in every project.",
        icon: "goodfirms",
      },
      {
        name: "Clutch",
        rating: "4.8",
        description: "4.8 Stars on Google – Trusted by clients for consistent quality and excellence.",
        icon: "clutch",
      },
    ],
  },
  ...
  clientSuccess: {
    ...
    caseStudies: [
      {
        image: "/images/client-succes-1.png",
        clientName: "The Red Shirt Guys",
        metrics: [
          { value: "+136%", label: "Organic Leads" },
          { value: "+41%", label: "Organic Impression" },
        ],
        testimonialParagraphs: [
          "\"We've worked with Icecube Digital for several years, and they've consistently delivered high-quality WordPress solutions that align perfectly with our clients' expectations and timelines. Their team is dependable, responsive, and easy to collaborate with, even on complex builds.",
          "What stands out most is their clear communication and thoughtful recommendations throughout the project lifecycle. They don't just execute tasks—they help refine ideas and improve workflows. Icecube Digital has become a trusted partner we can rely on to deliver quality work without surprises.\"",
        ],
        authorName: "Laura Windham",
        authorTitle: "Creative Director",
      },
      {
        image: "/images/client-succes-2.png",
        clientName: "West Coast Tree Service",
        metrics: [
          { value: "+140%", label: "Local Inquiries" },
          { value: "+109%", label: "Organic Inquiries" },
        ],
        testimonialParagraphs: [
          "\"Partnering with Icecube Digital has significantly improved how we manage white-label development. Their WordPress and SEO support has streamlined our internal processes and allowed us to handle larger, more complex projects with confidence.",
          "Because of their consistent quality and technical expertise, we've been able to scale our services without adding internal overhead. They function as a true extension of our agency, making it easier for us to grow while maintaining high standards for our clients.\"",
        ],
        authorName: "Joshua Kincheloe",
        authorTitle: "Director at JK Dreaming",
      },
      {
        image: "/images/client-succes-3.png",
        clientName: "Compassionate",
        metrics: [
          { value: "+614%", label: "Online Keywords" },
          { value: "+227%", label: "Organic Transactions" },
        ],
        testimonialParagraphs: [
          "\"Icecube Digital has been our go-to WordPress development partner for over five years. When one of our client websites was impacted by a Google update, their team quickly stepped in to diagnose the issue and implement targeted improvements.",
          "Their audit-led approach helped restore site performance, improve search visibility, and recover lost traffic and sales. The results were measurable and timely, reinforcing our confidence in their technical and SEO expertise. We continue to rely on them for long-term support and optimization.\"",
        ],
        authorName: "Steve Clark",
        authorTitle: "Director at Agency Replacement",
      },
    ],
    caseStudiesCtaLabel: "More Case Studies",
    caseStudiesCtaHref: "#",
    btnArrow: BTN_ARROW,
  },
  ...
  ourClients: {
    logos: [
      { src: "/images/out-client-1.png", alt: "" },
      { src: "/images/out-client-2.png", alt: "" },
      { src: "/images/out-client-3.png", alt: "" },
      { src: "/images/out-client-4.png", alt: "" },
      { src: "/images/out-client-5.png", alt: "" },
    ],
  },
  ...
  seoSay: {
    ...
    ctaLabel: "Contact Us Today for a Free Consultation!",
    ctaHref: "#",
    image: "/images/ceo-images.png",
    imageAlt: "",
    btnArrow: BTN_ARROW,
  },
};

export default whiteLabelWordpress;
