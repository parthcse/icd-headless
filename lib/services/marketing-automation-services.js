...
const MarketingAutomationServices = {
	...
	// textBox — "What is Marketing Automation?"
	textBox: {
		eyebrow: "What is",
	...
	featureCards: {
		...
		items: [
			...
			},
			{
				...
				name: "SEO & Paid Ads Campaign Automation",
	...
	iconCards: {
		...
		items: [
			...
			},
			{
				...
				name: "Campaign Automation & Optimization",
			...
			},
			{
				...
				name: "SEO & PPC Marketing Automation",
			...
			},
			{
				...
				name: "Marketing Reporting & Analytics Automation",
	...
	// featureCardsSecondary — "Marketing Automation Platforms We Work With" (left icon, 2-col)
	...
	// infoBoxes — "Benefits of Marketing Automation" (shaded boxes, no icons)
	infoBoxes: {
		eyebrow: "Benefits of",
		title: "Marketing Automation",
	...
	// featureCardsTertiary — "Our Marketing Automation Implementation Process" (numbered count icons, 2-col, step icon)
	featureCardsTertiary: {
		...
		items: [
			{
				icon: "/assets/icons/count-1.svg",
				name: "Business Analysis & Automation Planning",
			...
			{
				icon: "/assets/icons/count-4.svg",
				name: "Campaign Automation Implementation",
		...
		items: [
			{
				...
				name: "Experienced marketing automation specialists",
			...
			},
			{
				...
				name: "AI-powered marketing workflows",
			...
			},
			{
				...
				name: "Custom automation strategies",
			...
			},
			{
				...
				name: "CRM and marketing platform integration",
			...
			},
			{
				...
				name: "Data-driven campaign optimization",
	...
	// textBoxSecondary — "Ready to Automate Your Marketing?"
	textBoxSecondary: {
