		...
		items: [
			...
			},
			{
				...
				answer: [
					...
					" (SEO) is an ongoing process. It picks up the adjustments we do daily and gains momentum to drive high traffic. If you are a business owner, with an inventory and manpower to manage, then there is a high chance you don’t have adequate time to run optimized ad campaigns. This is where we come in. Hiring PPC management agencies could be one of the smartest moves since you don’t have to require second thoughts on onboarding leads.",
				],
			},
			{
