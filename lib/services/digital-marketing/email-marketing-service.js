	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answerList: [
					[{ bold: "Top-of-Funnel Drip" }, ": This marketing campaign initiates the conversation with your prospects."],
					[{ bold: "Educational Drip" }, ": This campaign ensures to educate your target audience about your brand and promotion offers."],
					[{ bold: "Re-engagement Drip" }, ": This marketing campaign aims at bringing back lost customers to your website and offering them the best service."],
				],
			},
			{
			...
			},
			{
				...
				answerList: [
					[{ bold: "Sentiment-aware personalization:" }, " Next-gen AI can detect and respond to emotional context in user data, crafting empathetic, tone-matched messages."],
					[{ bold: "Predictive customer journey mapping:" }, " AI is beginning to model entire user journeys, forecasting not just next actions but full sequences, leading to proactive workflow, and not like trigger-based."],
					[{ bold: "Agentic AI:" }, " Campaign agents can independently plan, launch, adjust, and optimize email campaigns across channels with minimal human oversight."],
				],
			},
			{
