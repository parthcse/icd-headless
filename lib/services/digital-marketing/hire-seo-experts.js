...
const HireSeoExperts = {
	...
	caseStudy: {
		...
		title: "Case Studies",
		subtitle: [
			"With the massive competition, your business needs customized SEO expert services that include advanced keyword research, competitor analysis, and in-depth technical SEO audits, and our best-in-class SEO experts do it all for you.",
			"We know what it takes to leverage search algorithms, optimize your site structure, and implement conversion-focused strategies to rank your website well in search engines and generate high ROI for your business. Our SEO experts bring proven SEO expertise, backed by industry-leading tools like Moz and Screaming Frog, to the table for you.",
			"Want to know what makes our SEO professionals stand out? Let us take a peek at their success stories!",
		],
