...
const MarketingAutomationServices = {
	...
	banner: {
		...
		paragraphs: [
			"Businesses invest in marketing tools, run multiple campaigns, and generate leads regularly, but converting those leads into customers remains inconsistent. The problem isn't a lack of marketing activities but the absence of a structured process. Leads are sitting in inboxes, follow-ups are delayed, campaign messaging becomes unclear, and the customer data remains underutilized.",
			"At Icecube Digital, a leading marketing automation company, helps address these operational gaps by setting workflow automation that connects marketing channels, customer data, and campaign execution into one unified system, and the actions are triggered based on user behaviour, engagement signals, and predefined business rules.",
		],
		...
		items: [
			...
			},
			{
				...
				body: [
					...
					{ text: "email marketing services", href: "/email-marketing-company/" },
	...
	infoBox: {
		...
		items: [
			...
			},
			{
				...
				body: "With marketing automation, a structured lead nurturing process is followed. AI-powered capabilities further strengthen this process by analyzing engagement patterns and deriving insights that help with assigning lead score, identifying high-intent prospects, and prioritizing leads. The sales rep can spend their efforts on the valuable ones, instead of targeting all, increasing the chances of conversions.",
			},
			{
				title: "Deliver personalized customer experiences",
				body: "Around 71% of customers expect personalized experiences, and 76% of them express frustration when they don't receive them. Manually delivering personalized experiences to every lead & customer can be time-consuming and resource-straining. However, marketing automation does it with ease by analyzing customer data and refining the messages accordingly.",
			},
			{
			...
			},
			{
				...
				body: "Marketing automation connects marketing platforms with CRM systems, ensuring that lead data flows directly to sales teams. No manual follow-ups, sharing spreadsheets, or asking updates from one team to another. Automated lead scoring, qualification, and routing help sales reps prioritise high-intent prospects and respond more efficiently.",
			},
		],
	},
	...
	processStepsSecondary: {
		...
		columns: 2,
		subtitle: "As an experienced service provider of automated marketing services, the success of marketing automation depends on 3 factors: starting simple (master one workflow before building ten), clean data (accurate data foundation builds a strong automation architecture), and clear goals (know what success looks like before we even begin). Here's how we set up the strong foundation of marketing automation:",
		steps: [
			{
			...
			},
			{
				...
				body: [
					...
					{ text: "AI digital marketing agency", href: "/ai-digital-marketing-services/" },
