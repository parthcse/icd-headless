...
const HireWordPressDevelopers = {
	...
	iconCards: {
		...
		items: [
			...
			{
				icon: "/images/woocommerce-dev.svg",
			...
			{
				icon: "/images/dedicated-dev.svg",
				name: "Hire Dedicated WordPress Developer",
	...
	imageText: {
		...
		image: "/images/reliable-partner.jpg",
