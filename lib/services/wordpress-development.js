...
const WordPressDevelopment = {
	...
	// Section 6 — textBox: "Partnering For Success"
	textBox: {
	...
	iconCards: {
		...
		subtitle:
			"Icecube Digital is a custom WordPress development company that does not rely on template solutions or shortcut strategies. Every project is designed with a goal that integrates your business goals, requirements, and a strategy to transform your website into an actual growth asset.",
		items: [
			{
			...
			{
				icon: "/images/services-offers-3.svg",
			...
			{
				icon: "/images/Chatbots.svg",
				name: "WordPress AI Integration Development",
	...
	iconCardsSecondary: {
		...
		items: [
			...
			},
			{
				...
				name: "Structured Data & Schema for AI Crawlers",
			...
			{
				icon: "/images/Chatbots.svg",
				name: "Intelligent Chatbot & Automation Integration",
			...
			},
			{
				...
				name: "Predictive Analytics & Conversion Optimization",
	...
	featureCards: {
		...
		items: [
			...
			{
				icon: "/images/wp-experience.svg",
				name: "Over 14 Years of Experience",
			...
			{
				icon: "/images/wp-specialization.svg",
				name: "WordPress Specialization",
			...
			{
				icon: "/images/wp-best-practices.svg",
				name: "Best Practices",
		...
		rows: [
			{
				...
				features: "Pre-built theme, basic customization, essential pages",
				investment: "$1,000 – $5,000",
			},
			{
				type: "Growth Website",
				bestFor: "Growing businesses",
				features: "Custom design, SEO-ready structure, integrations",
				investment: "$5,000 – $15,000",
			},
			{
				type: "Advanced / Custom Solution",
				bestFor: "Enterprises, high-scale projects",
				features: "Fully custom development, AI features, scalability",
				investment: "$15,000+",
			},
		],
	},
