...
const HireSeoExperts = {
	...
	testimonials: {
		...
		// Placeholder: reusing the PPC page's testimonialId until the WP id for
		// Sam Werkmeister (www.productphoto.com) is available.
		testimonialId: 24,
	},
	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "The ROI of hiring an SEO consultant comes from sustained organic traffic you don't pay for per click, higher-quality leads, and improved conversion rates. While SEO is a long-term investment, a skilled consultant focuses your budget on high-impact activities — so over time, the compounding traffic and rankings typically deliver a far greater return than the monthly cost.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "How long does it take to see results?",
				answer: "SEO is a long-term strategy, and meaningful results usually appear within 3 to 6 months, depending on your site's current authority, competition, and the scope of work. Technical fixes and on-page improvements can show early wins, while content and link building compound over time. We set realistic milestones and report progress every month so you always know where you stand.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "What should I look out for when hiring a consultant?",
				answer: "Look for proven experience, transparent reporting, ethical white-hat methods, and clear communication. A good consultant explains their strategy, sets realistic expectations, and shares measurable KPIs rather than promising overnight #1 rankings. Ask for case studies, the tools they use, and how they tailor strategy to your specific industry and goals.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "How do you measure success in your campaigns?",
				answer: "We measure success against KPIs tied to your business goals — organic traffic growth, keyword rankings, click-through rates, conversions, and return on investment. Using tools like Google Analytics, Search Console, SEMrush, and Ahrefs, we track performance continuously and deliver transparent monthly reports with actionable insights and next steps.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "Can I do the SEO myself without hiring a consultant?",
				answer: "You can handle SEO basics yourself, but ranking competitively requires time, specialized tools, and up-to-date expertise across technical SEO, content, and link building. A consultant brings experience, proven processes, and premium tools that would be costly to acquire alone — letting you focus on running your business while experts drive measurable, lasting growth.",
			},
		],
	},
