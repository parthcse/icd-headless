...
const HireWoocommerceDevelopers = {
	...
	// Figma "Flexible Hiring And Engagement Model" — image left, text right.
	imageText: {
	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "WooCommerce is one of the most flexible and widely used eCommerce platforms available. Built on WordPress, it's free, open-source, highly customizable, SEO-friendly, and supported by thousands of plugins and extensions — making it an excellent choice for businesses of all sizes, from small stores to large, complex catalogs.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "Who Will Own the Code of the Website?",
				answer: "You do. On completion and final payment, you retain full ownership of your website, its code, content, and all access credentials. We hand everything over so you have complete control of your WooCommerce store.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "How Do We Communicate Throughout the Project?",
				answer: "You'll have regular, direct communication with your team through your preferred channels — email, Slack, Skype, video calls, or project management tools like Jira and Trello. We follow agile practices with frequent updates and a dedicated point of contact to keep everything aligned.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "Who Will be My Point of Contact During Project Tenure?",
				answer: "We assign a dedicated project manager as your single point of contact throughout the engagement. They coordinate the team, keep you updated on progress, and ensure your requirements and feedback are addressed promptly.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "Why Should I Hire WooCommerce Experts from IceCube Digital?",
				answer: "With over a decade of experience and 200+ successful eCommerce projects, our certified WooCommerce developers bring deep platform expertise, transparent communication, flexible engagement models, and reliable ongoing support. We deliver tailored, scalable, and conversion-focused stores — making us a trusted long-term partner for your business growth.",
			},
		],
	},
