...
const WhiteLabelPpcServices = {
	...
	caseStudy: {
		...
		subtitle: [
			"Read our Case Studies to Understand the Impact of our White Label PPC Services",
			"With Icecube Digital, you are not just getting a service provider, you will be collaborating with a partner who values transparency and skills. We strive to be your dedicated technical experts, leveraging advanced tools like Google Ads Editor and SEMrush to craft high-performing campaigns. When you collaborate with us, we deliver you symbiotic solutions to handle the complexities of PPC advertising from data-driven keyword analysis using AI algorithms to dynamic campaign optimization based on performance metrics while you bask in the pride of stellar results.",
		],
	...
	plainText: {
		...
		paragraphs: [
			...
			[
				...
				{ text: "reporting, and comprehensive analytics", href: "/digital-marketing-analytics-reporting-services/" },
