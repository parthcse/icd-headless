...
const EcommerceWebsiteDevelopmentServices = {
	...
	textBox: {
		...
		paragraphs: [
			"We are one of the most compatible USA based ecommerce website developers, designers, and strategists, with a laser-sharp focus on making your online store a huge success. Whether you're launching a brand new ecommerce website, re-designing your existing website or looking to revamp your online presence, you've come to the right place.",
			"Here, at IceCube Digital, we understand your business and ensure that you reach your online potential. With years of experience and hundreds of clients across verticals, we have earned the trust of our clients as a top-notch ecommerce web development company that provides \"out-of-the-box\" solutions that engage with customers boosting sales.",
			"Here's our core ecommerce mantra – \"Boost your brand value while increasing your product sales.\"",
		],
		contentAlign: "center",
	...
	clientTrust: {
		...
		items: [
			...
			},
			{
				...
				name: "eCommerce Website UI/UX Design",
			...
			{
				icon: "/images/seo.svg",
				name: "eCommerce SEO & Digital Marketing",
			...
			},
			{
				...
				name: "eCommerce Migration & Upgrades",
	...
	clientRetention: {
		...
		image: "/images/ecommorce-web-development-left.png",
		imageAlt: "",
		paragraphs: [
		...
		items: [
			{
				...
				name: "eCommerce Industry Experts",
			...
			{
				icon: "/images/user.svg",
				name: "Skilled eCommerce Developers",
			...
			{
				icon: "/images/services-offers-5.svg",
				name: "Timely Delivery & Support",
