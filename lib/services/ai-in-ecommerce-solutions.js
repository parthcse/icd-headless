...
const AiInEcommerceSolutions = {
	...
	textBox: {
		...
		paragraphs: [
			"AI is a technology that trains a machine to act and think like human beings without explicitly being programmed by humans. With AI in eCommerce, regardless of the task or the department, AI can bring the desired productivity boost to deliver excellent results in the least possible time.",
			"In AI-powered eCommerce, every manual task becomes automated. You need personalized emails with a touch of creative copy for an email campaign? Generative AI in eCommerce can provide you with the first draft within minutes, which used to take at least 2 hours when done manually.",
			"You need a customer support team that answers users' queries 24/7 without chugging down cups of coffee? AI-powered conversational agents use Natural Language Processing (NLP) and machine learning to understand intent, context, and sentiment. They deliver instant, human-like responses while continuously learning from each interaction.",
			"Here's how and why AI matters in eCommerce, especially when old competitors are giving tough competition and new ones are emerging out of nowhere:",
		],
		listItems: [
		...
		outro:
			"With these many benefits, who wouldn't like to try AI integration services that can boost ROI in the long term? Companies that utilized AI-powered marketing automation have witnessed up to a 251% ROI.",
	...
	clientTrust: {
		...
		title: "For eCommerce",
		subtitle:
			"With the rise of AI-powered eCommerce, there is a range of solutions that you want to include in your business workflow to streamline a bunch of processes. From the marketing department to supply chain and logistics, there is an AI solution for every eCommerce activity. As your dedicated eCommerce development agency, we will provide you apt solution for all your use cases.",
		items: [
			{ icon: "/images/Smart-Search.svg", name: "Smart Search & Recommendations", body: "Why show the same results to everyone? AI-driven search understands typos, context, and even vague queries. Plus, recommendation engines analyze browsing, purchase history, and patterns to nudge shoppers toward products they didn't know they needed—but totally want." },
			{ icon: "/images/services-offers-3.svg", name: "AI-Powered Personalization", body: "No more one-size-fits-all. AI tracks user behavior across devices to tailor everything—from homepage banners to email offers. It's like giving each shopper their own concierge, powered by real-time machine learning and deep customer data." },
			{ icon: "/images/Chatbots.svg", name: "Chatbots & Virtual Assistants", body: "AI chatbots can answer your customers' queries day and night without any strain. With NLP and intent recognition, they answer FAQs, recommend products, process returns, and escalate the emergency or complex situation to your customer support executive." },
			{ icon: "/images/services-offers-7.svg", name: "Dynamic Pricing", body: "AI doesn't guess, but it calculates. By analyzing demand, competition, user behavior, and even time of day, dynamic pricing models optimize your prices on the fly to boost conversions and keep margins healthy. Smart, sneaky, and profitable." },
			{ icon: "/images/Predictive.svg", name: "Predictive Analytics", body: "Want to know what your customers will want next week? Predictive analytics sifts through past data to forecast trends, customer churn, lifetime value, and more. The machine learning algorithm is doing its future-telling thing." },
			{ icon: "/images/Smart.svg", name: "Smart Logistics", body: "AI takes the chaos out of fulfillment. It routes orders efficiently, predicts delivery windows, and optimizes warehouse operations with computer vision and real-time tracking. Faster, cheaper, smarter shipping minus the logistics headaches." },
			{ icon: "/images/Detection.svg", name: "AI Fraud Detection", body: "Every suspicious pattern gets flagged instantly. AI fraud systems use anomaly detection, behavioral analysis, and historical data to catch fake transactions before they cause damage—no cape, but definitely your store's silent superhero." },
			{ icon: "/images/Voice.svg", name: "Voice Search Optimization", body: "Find me red sneakers under $100 – the users find it easy to look for products with their voice assistants, like Siri. AI-powered voice search understands natural language, accents, and intent. It turns casual voice queries into accurate results, keeping your store one step ahead in a hands-free world." },
			{ icon: "/images/Inventory.svg", name: "Inventory Management", body: "No more stockouts or dead inventory. AI tracks sales velocity, seasonal shifts, and real-time trends to automate restocking and predict demand. Besides, the computer vision systems can keep track of the surroundings in real-time and alert if they find any errors or defects. Like, computer vision can quickly find out the expired products, and your team can remove them from the inventory." },
			{ icon: "/images/Generation.svg", name: "AI Content Generation", body: "Generative AI in eCommerce can generate SEO-friendly copy, ad headlines, and emails in seconds, trained on your brand tone and audience data. It creates content but is automated, scalable, and super fast, which needs a little fine-tuning and expert input to infuse the human touch." },
			{ icon: "/images/Shopping.svg", name: "AR Shopping with AI", body: "AI meets augmented reality to bring the try-before-you-buy experience online. From virtual try-ons to room previews, computer vision + real-time rendering = fewer returns and way more \"add to cart\" moments." },
			{ icon: "/images/Value.svg", name: "Customer Lifetime Value Prediction", body: "Not all customers are created equal. AI models calculate lifetime value by analyzing purchase frequency, basket size, and behavior trends, so you can spend smarter, target better, and retain the ones worth keeping." },
		],
	},
	...
	offers: {
		...
		items: [
			{ icon: "/images/Processing.svg", title: "Natural Language Processing (NLP)", body: "Computers cannot understand the language that we speak or write because they operate in binary code – 1s and 0s. Natural language processing enables machines to recognize, understand, and generate text and speech in our language." },
			{ icon: "/images/Voice.svg", title: "Machine Learning (ML)", body: "Machine learning, as the name suggests, comprises algorithms and models that help a machine learn using trained data without being explicitly programmed. ML helps the machine to learn from data, analyze the pattern, figure out the logic, and use it on unknown data, and improve its performance." },
			{ icon: "/images/eye.svg", title: "Computer Vision", body: "Computer vision helps computers derive and extract important information from images, videos, and other visual inputs. The information extracted helps the systems to make recommendations and take action in real-time as it notices issues and defects." },
	...
	development: {
		...
		ctaHref: "#",
		image: "/images/Generative-AI-in-eCommerce.png",
		imageAlt: "",
		btnArrow: BTN_ARROW,
	},
	...
	qualityWebsites: {
		...
		items: [
			{ icon: "/images/count-1.svg", name: "Define Your Business Goals", body: "Before adopting any AI solution, be clear about what you want to achieve—boosting sales, reducing churn, automating support, or personalizing experiences. Clear goals help guide the right use cases and ensure your investment drives real results." },
			{ icon: "/images/count-2.svg", name: "Audit and Organize Your Data", body: "AI thrives on clean, structured, and relevant data. Audit your existing databases, remove redundancies, and categorize key metrics like customer behavior, transactions, and product info to give AI models the fuel they need to work effectively." },
			{ icon: "/images/count-3.svg", name: "Choose the Right AI Tools", body: "Select AI tools that align with your business size, goals, and existing tech stack. Whether it's a recommendation engine, chatbot, or analytics suite, look for scalability, integration capabilities, and proven success in the eCommerce space." },
			{ icon: "/images/count-4.svg", name: "Integrate AI with the Platform", body: "Once chosen, integrate your AI tools with your eCommerce platform, CRM, and marketing stack. Smooth integration ensures real-time data flow and enables AI to power everything from personalization to logistics without breaking the user experience." },
			{ icon: "/images/count-5.svg", name: "Train Your Team", body: "AI tools need more than plug-and-play. They need people who can manage, interpret, and adjust them. Upskill your marketing, product, and support teams to collaborate with AI systems and use insights for smarter decision-making." },
			{ icon: "/images/count-6.svg", name: "Monitor & Optimize Continuously", body: "AI is not a set-it-and-forget-it solution. Continuously track performance, review results, and refine your models based on real-world feedback. Regular optimization ensures your AI evolves with market trends, customer behavior, and business growth." },
		],
	...
	qualityWebsitesSecondary: {
		...
		items: [
			{ icon: "/images/Inventory.svg", name: "We understand eCommerce inside out", body: "With years of experience building and optimizing online stores, we know what drives conversions, loyalty, and growth. Our AI solutions are built on a foundation of real eCommerce insight, not guesswork or one-size-fits-all playbooks." },
			{ icon: "/images/grid.svg", name: "Easy integration with your existing setup", body: "No need to rebuild everything. Our solutions integrate seamlessly with major eCommerce platforms, CRMs, and marketing tools. It minimizes disruption while maximizing impact." },
			{ icon: "/images/services-offers-1.svg", name: "Custom solutions for your business", body: "Your brand is unique, and so are your challenges. We craft AI strategies and models specifically for your workflows, customer base, and KPIs, so every feature adds value from day one." },
			{ icon: "/images/like.svg", name: "AI that actually works for you", body: "We don't do shiny tools that sit unused. Our AI systems are practical, proven, and aligned with your business goals. It drives automation, boosts personalization, and turns data into decisions that matter." },
			{ icon: "/images/Chatbots.svg", name: "Support that sticks around", body: "We are your AI integration partner, not just a vendor. We work as your extended team. From strategy to implementation and beyond, our AI SEO and AI integration team stays connected to ensure your AI evolves as your business does." },
			{ icon: "/images/income.svg", name: "Real results, real experience", body: "We've delivered scalable AI solutions for brands across industries, helping them personalize experiences, automate operations, and improve performance, with measurable outcomes that speak for themselves." },
			{ icon: "/images/comment.svg", name: "Simple, clear communication", body: "We don't bury you in tech jargon. Our approach is transparent, collaborative, and focused on making sure you always know what's happening and why it matters." },
			{ icon: "/images/time.svg", name: "Trusted by top brands", body: "Our work speaks for itself. Leading eCommerce brands trust Icecube Digital to deliver reliable, intelligent, and scalable AI solutions that fuel real growth." },
		],
	},
