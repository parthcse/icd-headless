...
const Magento2Development = {
  ...
  plainText: {
    ...
    blocks: [
      { type: "p", parts: [
        "With the launch of Magento 2 at the end of 2015, the next-generation open source digital commerce platform has become one of the most favorite platforms for developers. Not only this, but because it effectively offers an omnichannel shopping experience without any hassle, it has become the choice of retailers and business owners, too. Magento is the most versatile and popular eCommerce platform that offers the perfect environment for business growth to business owners. Giving complete control over the presentation, content, and functionality of the online store, ",
        { text: "Magento development services", href: "/magento-development-services/" },
        " offer flexibility to its users to update the shopping portal with ease.",
      ] },
      { type: "p", parts: [
        "Being a leading ",
        { bold: "Magento 2 development company in the USA" },
        ", IceCube Digital focuses on satisfying its clients with its flawless Magento 2 eCommerce development services around the globe. With certified Magento 2 developers, we always give comprehensive support and solutions to the needs of clients, understanding the global market. We always make efforts to support digital stores in achieving their targets and drawing more and more business from the target audience, expanding the loyal customer base.",
      ]},
    ],
  ...
  cta: {
    text: "Launch your dream website with our trusted Magento 2 development services!",
