...
const HireMagento2Migration = {
  ...
  banner: {
    ...
    closingParagraph: "Get a smooth upgrade without risking your store.",
  ...
  topIconBox: {
    ...
    subtitle: "If you're still on an older Magento version, you're already at a disadvantage.",
    items: [
      {
    ...
    steps: [
      {
        ...
        body: "We analyze your current store, including:",
        bodyList: [
          "Extensions and integrations",
          "Performance issues",
          "SEO structure",
        ],
        bodyAfter: "Then we create a clear upgrade roadmap.",
      },
      {
        title: "Backup & Environment Setup",
        bodyList: [
          "Full backup of your existing store",
          "Setup of staging environment",
          "Preparation for safe upgrade execution",
        ],
      },
      {
        title: "Upgrade / Migration Execution",
        bodyList: [
          "Magento version upgrade or platform migration",
          "Extension updates and compatibility fixes",
          "Theme development or adaptation",
        ],
      },
      {
        title: "Testing & QA",
        body: "We test everything:",
        bodyList: [
          "Checkout process",
          "Payment gateways",
      ...
      },
      {
        ...
        bodyList: [
          ...
          "Ongoing support and fixes (if needed)",
        ],
      },
    ],
  },
