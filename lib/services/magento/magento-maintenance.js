	...
	topIconBoxSecondary: {
		...
		items: [
			...
			},
			{
				...
				body: ["Our experts will help you manage your Magento store's transition from ", { text: "Magento 1 to Magento 2", href: "/magento-2-upgrade-and-migration-services/" }, ", the latest version of Magento. Our experts manage the entire upgrade process, including security patch installation, software updates, plugin issue resolution after migration, compatibility checks, and seamless functioning of your store, ensuring a smooth transition."],
			},
			{
	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "Yes, our Magento maintenance services include round-the-clock emergency support, ensuring that assistance is available whenever you need it, including weekends and holidays.",
			},
			{
				question: "Can I upgrade or downgrade my Magento support package based on changing requirements?",
				answer: "Yes, our flexible and scalable engagement models allow you to seamlessly upgrade or downgrade your working hours based on your evolving business needs, providing adaptability to changing circumstances.",
			},
			{
				question: "What happens if my site encounters issues during maintenance?",
				answer: "Our dedicated support team is equipped to address any issues promptly during maintenance, minimizing downtime and ensuring a smooth user experience. With IceCube Digital on your side, we’ll ensure that your online store is in expert hands, and any challenges will be efficiently resolved.",
			},
			{
				question: "What are the advantages of opting for personalized consultations in Magento maintenance services?",
				answer: "Choosing personalized consultations ensures that our maintenance efforts align with your long-term business objectives, fostering continuous improvement and growth. It allows for a collaborative approach to discuss your e-commerce goals and strategies, tailoring our services to meet your unique needs effectively.",
			},
			{
				question: "Get Started with IceCube Digital's Magento Maintenance Services",
				answer: "Unlock the full potential of your Magento store with IceCube Digital’s comprehensive and reliable Magento maintenance services. Whether you’re a small business or a large enterprise, our experienced team is dedicated to ensuring the optimal performance, security, and growth of your eCommerce platform. Join the ranks of satisfied clients who have witnessed the transformative power of IceCube Digital as the best Magento development agency . Elevate your Magento experience with a team committed to your success. Contact us to discuss your magento maintenance needs.",
			},
		],
	},
