	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "Slow-loading, error-filled, confusing-to-navigate web pages are common issues affecting the entire SEO strategy, and you cannot see the results. However, at Icecube Digital, we take care of every aspect to ensure our clients get the expected result with which they approach us. At the core, our technical SEO experts are designed to enrich your overall user experience and here’s how we can assure you a steady growth with SEO:",
				answerList: [
