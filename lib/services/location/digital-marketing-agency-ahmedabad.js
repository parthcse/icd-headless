...
const DigitalMarketingAgencyAhmedabad = {
	...
	imageText: {
		...
		blocks: [
			...
			{ text: "Bonus Add-ons", strong: true },
			{
				type: "ul",
				items: ["WhatsApp Lead Capture", "Heatmaps", "Call & Form Tracking"],
			},
		],
	},
	...
	plainText: {
		eyebrow: "Meet Your Digital Marketing",
		title: "Experts in Ahmedabad",
		contentAlign: "center",
		paragraphs: [
	...
	scrollNavigation: {
		eyebrow: "When Strategy Works,",
		title: "Growth Follows",
		items: [
			{
				title: "Explosive Growth in 6 months",
				image: "/assets/photos/dm-result-1.png",
			...
			},
			{
				...
				image: "/assets/photos/dm-result-2.png",
			...
			},
			{
				...
				image: "/assets/photos/dm-result-3.png",
			...
			},
			{
				...
				image: "/assets/photos/dm-result-4.png",
	...
	topIconBox: {
		eyebrow: "Core Digital Marketing",
		title: "Services in Ahmedabad",
		subtitle:
	...
	topIconBoxSecondary: {
		eyebrow: "Why Choose Our Digital Marketing",
		title: "Company in Ahmedabad",
		subtitle:
