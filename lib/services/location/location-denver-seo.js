...
const DenverSeoAgency = {
	...
	plainText: {
		eyebrow: "Grow Your Business With Our Top",
		title: "Denver SEO Services Near You",
		contentAlign: "center",
		paragraphs: [
			[
	...
	leftIconBox: {
		eyebrow: "Benefits Of Hiring Our Denver SEO",
		title: "Experts For Your Business",
		items: [
			{
	...
	topIconBox: {
		eyebrow: "Denver SEO Services To Suffice",
	...
	checkList: {
		eyebrow: "Ready To Hire Icecube Digital As Your",
		title: "Denver SEO Partner?",
