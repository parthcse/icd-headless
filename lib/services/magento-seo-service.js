...
const MagentoSeoService = {
	...
	clientTrust: {
		...
		items: [
			...
			{
				icon: "/images/seo.svg",
				name: "On Page and Off-page SEO setup",
			...
			{
				icon: "/images/web.svg",
				name: "Responsive Design and web development",
	...
	clientTrustSecondary: {
		...
		items: [
			{
				icon: "/images/seo.svg",
				name: "Experience, Expertise and Strategies",
	...
	clientRetention: {
		...
		image: "/images/magento-seo-experts.png",
