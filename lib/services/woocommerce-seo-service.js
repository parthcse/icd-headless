...
const WoocommerceSeoService = {
	...
	// Figma "Get Your FREE SEO Audit Report Now!" — SEO audit form with result image.
	seoAuditForm: {
	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "SEO is a long-term investment. Most stores see meaningful improvements in 3 to 6 months, depending on the site's current state, competition, and scope of work. Technical fixes can yield early wins, while content and authority-building compound over time. We provide transparent monthly reporting so you can track progress.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "Why is SEO important for WooCommerce stores?",
				answer: "SEO drives free, high-intent organic traffic to your store, helping your products and categories rank for the keywords your customers actually search. This increases visibility, builds brand authority, and delivers better conversion rates and ROI than many paid channels — making it essential for sustainable eCommerce growth.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "How much does your Woocommerce SEO service cost?",
				answer: "Costs depend on your store's size, competition, and the scope of work involved. We offer flexible plans starting at $500/month and tailor a package to your goals and budget. Request a free SEO audit and we'll review your store and provide a custom proposal.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "What are some of the on-page optimization techniques you use for Woocommerce SEO?",
				answer: "Our on-page work includes keyword-optimized product and category titles, descriptions, and meta tags, clean URL structures, image alt text and compression, structured data for rich snippets, internal linking, header optimization, and improvements to page speed and mobile responsiveness — all aligned to search intent.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "What Are The WooCommerce SEO Challenges?",
				answer: "Common challenges include duplicate content from product variants and filters, thin category and product descriptions, slow page speed on large catalogs, plugin and theme conflicts, and crawl/index issues. We address these with canonical tags, optimized content and architecture, performance tuning, and technical fixes tailored to WooCommerce.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "Shopify Vs. WooCommerce – Which one is better for SEO?",
				answer: "Both can rank well. WooCommerce, built on WordPress, offers deeper control over technical SEO, URL structure, content, and plugins, which is great for content-driven strategies. Shopify is simpler to manage with strong defaults. The best choice depends on your needs — and with proper optimization, WooCommerce gives you maximum flexibility.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "How can I improve my WooCommerce site's local SEO?",
				answer: "We improve local SEO by optimizing your Google Business Profile, adding local keywords and location pages, ensuring NAP consistency, building local citations and reviews, and implementing local schema. This helps your store appear in local search results and Google Maps, driving nearby customers to your business.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "Do you provide any guarantee for SEO results?",
				answer: "No reputable agency can guarantee specific rankings, since search engines control their algorithms. What we guarantee is a proven, white-hat strategy, transparent reporting, and consistent effort that reliably improves visibility, traffic, and conversions over time. Beware of anyone promising guaranteed #1 rankings.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "Do you optimize both product and category pages?",
				answer: "Yes. We optimize product pages with keyword-rich titles, descriptions, images, and schema, and we enhance category pages with unique descriptions, internal links, and relevant keywords. Category pages often hold strong ranking potential for high-intent searches, so both are central to our WooCommerce SEO strategy.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "Will SEO help my WooCommerce store appear in AI Overviews (AIO)?",
				answer: "Yes. Strong SEO foundations — structured data, clear and authoritative content, fast performance, and topical relevance — improve your chances of being surfaced in AI Overviews and other AI-driven search experiences. We optimize your store to be easily understood and cited by both traditional search and AI systems.",
			},
			{
				// TODO: draft answer — replace with final approved copy
				question: "Do you also provide WooCommerce site speed optimization?",
				answer: "Yes. Site speed is a core part of our service. We optimize images, code, caching, and hosting configuration, minimize HTTP requests, and improve Core Web Vitals — keeping your store fast, reducing bounce rates, and supporting better rankings and conversions.",
			},
		],
	},
