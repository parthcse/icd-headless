...
const WordPressMaintenance = {
	...
	portfolio: {
		...
		// TODO: replace with the real WordPress `portfolio` post IDs for Jelani Travel, Stompers Gloves, 8 Green Bottles
		postIds: [71, 65, 73],
		...
		items: [
			{
				...
				name: "Enhance Overall Website Security",
			...
			},
			{
				...
				name: "Run Your Website Faster, and Smoother",
			...
			},
			{
				...
				name: "Improved SEO & Better Conversions",
			...
			{
				icon: "/assets/icons/database-backup.svg",
				name: "Regular and Accessible Backups",
	...
	testimonials: {
		...
		// TODO: confirm testimonial ID for WordPress maintenance client
		testimonialId: 24,
	},
	...
	topIconBoxSecondary: {
		...
		items: [
			...
			},
			{
				...
				name: "Unlimited 24/7 Website Updates",
			...
			},
			{
				...
				name: "Plugins, Themes & Files Updates",
			...
			},
			{
				...
				name: "Core Files & Database Backup",
