...
const ShopifyMaintenance = {
	...
	// Figma "Our Flexible Hiring Models" — Fixed Price Model (image left, with section heading).
	imageText: {
	...
	// Figma "Hourly Model" — image right, no section heading (continuation of hiring models).
	imageTextSecondary: {
	...
	// Figma "Dedicated Hiring" — image left, no section heading (continuation of hiring models).
	imageTextTertiary: {
	...
	// Table section: components/services/ServicesTablePricingPlans.js (same matrix as shopify-plus-support).
	tablePricingPlans: {
		eyebrow: "Shopify",
