...
const WhyWorkWithUs = {
	...
	simpleBanner: {
		...
		paragraphs: [
			"An award-winning team delivering eCommerce websites, mobile apps, and SEO — here are the reasons clients choose to work with us.",
		],
	},
	...
	imageTextSecondary: {
		eyebrow: "We Care For Our Customers",
		title: "And Our Team",
		video: "https://www.youtube.com/embed/9e8EkgN5wTY",
		imageAlt: "Icecube Digital — we care for our customers and our team",
		paragraphs: [
	...
	topIconBox: {
		...
		title: "Choose Us",
		columns: 3,
		iconClass: "h-40 w-auto max-w-full",
		items: [
