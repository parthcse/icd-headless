...
// Statuses that usually mean a transient block (Cloudflare challenge / rate
// limit / gateway) rather than a real error. At build time Vercel fires many
// requests at the origin from one datacenter IP, so a few get challenged —
// retry those instead of silently rendering an empty section.
