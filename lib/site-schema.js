...
const organization = {
  ...
  name: "Icecube Digital",
  // Static aggregate rating. IMPORTANT: it lives on the Organization, NOT the
  // LocalBusiness. The LocalBusiness has a nested `department` (the India office),
  // and a rating there made Google detect TWO rated items → "Review has multiple
  // aggregate ratings". The Organization has no department, so this is the single
  // rated entity in the graph and that error can't recur. Update the numbers here.
  aggregateRating: {
